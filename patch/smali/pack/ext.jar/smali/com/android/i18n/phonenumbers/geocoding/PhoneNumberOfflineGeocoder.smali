...
.method private getAreaDescriptionForNumber(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 323
    invoke-virtual/range {p1 .. p1}, Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;->getNationalNumber()J
    ...
    .line 325
    .local v8, "nationalNumberStr":Ljava/lang/String;
    ...
    .end local v8    # "nationalNumberStr":Ljava/lang/String;
    .local v9, "phonePrefix":I
    :goto_0
    ...
    invoke-direct {p0, v9, v0, v1, v2}, Lcom/android/i18n/phonenumbers/geocoding/PhoneNumberOfflineGeocoder;->getPhonePrefixDescriptions(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;

    move-result-object v10

    .line 339
    .local v10, "phonePrefixDescriptions":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    if-eqz v10, :cond_4

    move-object/from16 v0, p1

    invoke-virtual {v10, v0}, Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;->lookup(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/i18n/phonenumbers/geocoding/PhoneNumberOfflineGeocoder;->mayFallBackToEnglish(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v9, v11, v12, v13}, Lcom/android/i18n/phonenumbers/geocoding/PhoneNumberOfflineGeocoder;->getPhonePrefixDescriptions(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;

    move-result-object v4

    .line 345
    .local v4, "defaultMap":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    if-nez v4, :cond_5
    ...
    .line 350
    .end local v4    # "defaultMap":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    :goto_2
    return-object v11

    .line 329
    .end local v5    # "description":Ljava/lang/String;
    .end local v9    # "phonePrefix":I
    .end local v10    # "phonePrefixDescriptions":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    .restart local v6    # "nationalNumber":J
    .restart local v8    # "nationalNumberStr":Ljava/lang/String;
    :cond_1
    const/16 v9, 0x35c

    .restart local v9    # "phonePrefix":I
    goto :goto_0
    ...
    .line 339
    .restart local v10    # "phonePrefixDescriptions":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    :cond_4
    const/4 v5, 0x0
    ...
    .line 348
    .restart local v4    # "defaultMap":Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;
    .restart local v5    # "description":Ljava/lang/String;
    :cond_5
    move-object/from16 v0, p1

    invoke-virtual {v4, v0}, Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;->lookup(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;)Ljava/lang/String;
...
.method public getDescriptionForValidNumber(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/i18n/phonenumbers/geocoding/PhoneNumberOfflineGeocoder;->getDescriptionForValidNumber(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/util/Locale;Ljava/lang/String;Z)Ljava/lang/String;
...
.method public getDescriptionForValidNumber(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/util/Locale;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1, v5, v4}, Lcom/android/i18n/phonenumbers/geocoding/PhoneNumberOfflineGeocoder;->getAreaDescriptionForNumber(Lcom/android/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
