...
.method public isGuestModePasswordLegal(Landroid/content/ContentResolver;Ljava/lang/String;)Z
    .locals 8
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    .param p2, "password"    # Ljava/lang/String;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "#huangxiaotao@SHELL guest mode password can\'t equal to screen password, so check it "
    ...
    .line 1536
    .local v1, "lockScreenPasswordFrontFour":[B
    :try_start_0
    const-string v5, "meizu_password_fronts_four"
    ...
    const-string v7, "check _pwd_front_four exception = "
...
.method public saveLockPasswordFrontFour(Landroid/content/ContentResolver;Ljava/lang/String;)V
    .locals 5
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    .param p2, "password"    # Ljava/lang/String;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "#huangxiaotao@SHELL save the front four password for checking the guest mode password"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .local v1, "hash":[B
    :try_start_0
    const-string v2, "meizu_password_fronts_four"
    ...
    invoke-static {p1, v2, v3}, Landroid/provider/Settings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0
