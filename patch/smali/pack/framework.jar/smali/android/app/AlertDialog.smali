...
.field public static final TITLE_CENTER_HIGHLIGHT:I = 0x1
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "suyouxiong@SDK.Feature. add the title style constant"
...
.method static synthetic access$102(Landroid/text/TextUtils$TruncateAt;)Landroid/text/TextUtils$TruncateAt;
    .locals 0
    .param p0, "x0"    # Landroid/text/TextUtils$TruncateAt;
...
.method protected applyMeizuStyle(Landroid/app/AlertDialog;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "suyouxiong@SDK.Feature.add meizu\'s style for alertdialog"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature. init the alertdialog\'s content"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setButtonClickDismiss(IZ)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add whether the dialog will dismiss when click the button"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setButtonTextColor(II)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add Set the color of text for special button"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/app/AlertController;->setButtonTextColor(II)V
...
.method public setCustEditViewHasMargin(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/app/AlertController;->setCustEditViewHasMargin(Z)V
...
.method public setListViewLayoutWidth(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/app/AlertController;->setListViewLayoutWidth(I)V
...
.method public setMessage(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/internal/app/AlertController;->setMsgAlignType(I)V
...
.method public setWidth(I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add set the dialog\'s width"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public show()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add every time the dialog shows, some thing must be check"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0}, Lcom/android/internal/app/AlertController;->onShowingCheck()V
