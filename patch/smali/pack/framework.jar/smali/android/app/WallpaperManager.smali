...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/app/WallpaperManager$GlobalsInjector;,
...
.field private static final CUSTOM_LOCKWALLPAPERPATH:Ljava/lang/String; = "/custom/meizu/wallpaper/default_lock_wallpaper.png"
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    new-instance v1, Landroid/app/WallpaperManager$GlobalsInjector;

    invoke-direct {v1, p0}, Landroid/app/WallpaperManager$GlobalsInjector;-><init>(Landroid/app/WallpaperManager;)V

    invoke-virtual {v0, v1}, Landroid/app/WallpaperManager$Globals;->setInjector(Landroid/app/WallpaperManager$GlobalsInjector;)V

    .line 500
    return-void
.end method

.method static synthetic access$1000()Landroid/app/WallpaperManager$Globals;
    .locals 1
...
.method static synthetic access$500()Z
    ...
    .prologue
    .line 85
    invoke-static {}, Landroid/app/WallpaperManager;->checkMzWallpaperPath()Z
...
.method private static checkMzWallpaperPath()Z
    .locals 2
    ...
    const-string v1, "/custom/meizu/wallpaper/default_wallpaper.png"
...
.method private setLockWallpaper(Ljava/io/InputStream;Ljava/io/FileOutputStream;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "Globals injector to get lock wallpaper stream"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public clearLockWallpaper()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "set default lock wallpaper"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public getDrawableOfLockWallpaper()Landroid/graphics/drawable/Drawable;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Globals injector to get lock wallpaper drawable"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    iget-object v2, v2, Landroid/app/WallpaperManager$Globals;->mGlobalsInjector:Landroid/app/WallpaperManager$GlobalsInjector;

    iget-object v3, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;

    const/4 v4, 0x1

    invoke-virtual {v2, v3, v4}, Landroid/app/WallpaperManager$GlobalsInjector;->peekLockWallpaperBitmap(Landroid/content/Context;Z)Landroid/graphics/Bitmap;
...
.method public getFastDrawableOfLockWallpaper()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v3, Landroid/app/WallpaperManager$Globals;->mGlobalsInjector:Landroid/app/WallpaperManager$GlobalsInjector;

    iget-object v4, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;

    const/4 v5, 0x1

    invoke-virtual {v3, v4, v5}, Landroid/app/WallpaperManager$GlobalsInjector;->peekLockWallpaperBitmap(Landroid/content/Context;Z)Landroid/graphics/Bitmap;
...
.method public getLockWallpaperBitmap()Landroid/graphics/Bitmap;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "get lock wallpaper bitmap"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0, v1, v2}, Landroid/app/WallpaperManager$GlobalsInjector;->peekLockWallpaperBitmap(Landroid/content/Context;Z)Landroid/graphics/Bitmap;
...
.method public getSmartWallpaperTarget()Landroid/graphics/Bitmap;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "get smart wallpaper target"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0}, Landroid/app/WallpaperManager$GlobalsInjector;->getSmartWallpaperTarget()Landroid/graphics/Bitmap;
...
.method public peekDrawableOfLockWallpaper()Landroid/graphics/drawable/Drawable;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Globals injector to peek lock wallpaper drawable"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setBitmap(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Landroid/app/WallpaperManager$Globals;->access$800(Landroid/app/WallpaperManager$Globals;Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method public setBitmapToLockWallpaper(Landroid/graphics/Bitmap;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Globals injector to get lock wallpaper bitmap"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setResourceToLockWallpaper(I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Globals injector to set lock wallpaper resource"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setSmartWallpaperTarget(Landroid/graphics/Bitmap;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "set smart wallpaper target"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Landroid/app/WallpaperManager$GlobalsInjector;->setSmartWallpaperTarget(Landroid/graphics/Bitmap;)Z
...
.method public setWallpaperAndLockWallpaper(Landroid/graphics/Bitmap;)V
    .locals 4
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "mz yfy add, set wallpaper and lockwallpaper together"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1711
    invoke-virtual {p0, p1}, Landroid/app/WallpaperManager;->setBitmapToLockWallpaper(Landroid/graphics/Bitmap;)V
    ...
    const-string/jumbo v2, "smart_wallpaper_enabled"
...
.method public setWallpaperAndLockWallpaperRes(I)V
    .locals 4
    .param p1, "res"    # I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "mz yfy add, set wallpaper and lockwallpaper res together"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1726
    invoke-virtual {p0, p1}, Landroid/app/WallpaperManager;->setResourceToLockWallpaper(I)V
...
.method public setWallpaperAndLockWallpaperStream(Ljava/io/InputStream;)V
    .locals 4
    .param p1, "data"    # Ljava/io/InputStream;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "mz yfy add, set wallpaper and lockwallpaper input stream together"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1741
    invoke-virtual {p0, p1}, Landroid/app/WallpaperManager;->setStreamToLockWallpaper(Ljava/io/InputStream;)V
