...
# instance fields
.field private final ACTIONMODE_HEADER_HIDDEN:Ljava/lang/String;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "cjy@SDK.Feature. add to InstanceState save and restore ActionMode hidden"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field

.field private mAccessControlManager:Landroid/content/AccessControlManager;
...
.field private mActionBarToTop:Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature. add to mark the state that the actionBar extend its top edge to the below of statusBar"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private mActionModeHeaderHidden:Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "cjy@SDK.Feature. add to save ActionMode states"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    .line 780
    iput-boolean v1, p0, Landroid/app/Activity;->mActionModeHeaderHidden:Z

    .line 786
    const-string v0, "actionmode_header_hidden"

    iput-object v0, p0, Landroid/app/Activity;->ACTIONMODE_HEADER_HIDDEN:Ljava/lang/String;

    .line 792
    iput-boolean v1, p0, Landroid/app/Activity;->mActionBarToTop:Z
...
.method private initActionBar()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "cjy@SDK.Feature. add to register SmartBarSettingObserver"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method private setTranslucentStatus(Z)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "suyouxiong@SDK.Feature set the status bar to be translucent"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method final attach(Landroid/content/Context;Landroid/app/ActivityThread;Landroid/app/Instrumentation;Landroid/os/IBinder;ILandroid/app/Application;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/CharSequence;Landroid/app/Activity;Ljava/lang/String;Landroid/app/Activity$NonConfigurationInstances;Landroid/content/res/Configuration;)V
    ...
    .line 5323
    :cond_1
    iget-object v1, p8, Landroid/content/pm/ActivityInfo;->mFlymeActivityInfo:Landroid/content/ActivityInfoExt;
    ...
    iget-object v2, p8, Landroid/content/pm/ActivityInfo;->mFlymeActivityInfo:Landroid/content/ActivityInfoExt;

    iget v2, v2, Landroid/content/ActivityInfoExt;->meizuSystemUIOptions:I

    invoke-virtual {v1, v2}, Landroid/view/Window;->setMeizuSystemUIOptions(I)V
...
.method public injectAccessControl()V
    .locals 9
    ...
    .line 5622
    :cond_0
    iget-object v6, p0, Landroid/app/Activity;->mAccessControlManager:Landroid/content/AccessControlManager;
    ...
    check-cast v6, Landroid/content/AccessControlManager;

    iput-object v6, p0, Landroid/app/Activity;->mAccessControlManager:Landroid/content/AccessControlManager;
    ...
    invoke-virtual {v6, v7}, Landroid/content/AccessControlManager;->checkAccessControl(Ljava/lang/String;)Z
...
.method public isActionBarToTop()Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature return the flag of mActionBarToTop"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "cjy@SDK.Feature. add to Restore ActionMode Hidden"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected onDestroy()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "cjy@SDK.Feature. add to unregister SmartBarSettingObserver"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected tos_org_onResume()V
    ...
    .line 1142
    invoke-virtual {p0}, Landroid/app/Activity;->injectAccessControl()V
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 1262
    const-string v2, "actionmode_header_hidden"
    ...
    invoke-virtual {v1}, Lcom/android/internal/app/ActionBarImpl;->getActionModeHeaderHidden()Z
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/app/ActionBarImpl;->setActionModeHeaderHidden(Z)V
...
.method public overridePendingCustomTransition(Landroid/view/WindowAnimationInfo;Landroid/view/WindowAnimationInfo;)V
    .locals 3
    .param p1, "enterAnim"    # Landroid/view/WindowAnimationInfo;
    .param p2, "exitAnim"    # Landroid/view/WindowAnimationInfo;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
...
.method final performCreate(Landroid/os/Bundle;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Cui.Yingyun@Shell.PerformaceObserver. Trace app launch time"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    const-string v4, "MZPerfObserver"
    ...
    const-string v6, " onCreate consume "
    ...
    invoke-virtual {v3}, Landroid/app/FragmentManagerImpl;->dispatchActivityCreated()V
...
.method public setActionBarToTop(Z)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature set the flag of mActionBarToTop"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
