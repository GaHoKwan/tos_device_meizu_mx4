...
.method protected getCurrentHeader()Landroid/preference/PreferenceActivity$Header;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Feature get Current Header"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public loadHeadersFromResource(ILjava/util/List;)V
    ...
    const-string/jumbo v14, "loadHeadersFromResource"
...
.method public setActionBarToTop(Z)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature let the activity\'s actionBar extend its top edge to the below of statusBar"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1636
    .local v7, "prefsListView":Landroid/widget/ListView;
    if-eqz v7, :cond_1
    ...
    .line 1640
    invoke-virtual {v6, v13}, Landroid/preference/PreferenceScreen;->getPreference(I)Landroid/preference/Preference;
    ...
    invoke-virtual {v9, v10, v13}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v7, v9, v10, v11, v12}, Landroid/widget/ListView;->setPadding(IIII)V
    ...
    :goto_1
    invoke-virtual {v7, v13}, Landroid/widget/ListView;->setClipToPadding(Z)V

    .line 1676
    .end local v0    # "actionBarHight":I
    .end local v4    # "marginToActionBar":I
    ...
    .line 1644
    .restart local v4    # "marginToActionBar":I
    ...
    instance-of v9, v5, Landroid/preference/Preference;
    ...
    invoke-virtual {v7, v9, v4, v10, v11}, Landroid/widget/ListView;->setPadding(IIII)V
...
.method protected setListFooter(Landroid/widget/FrameLayout;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature set List Footer"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected setPrefsContainer(Landroid/view/ViewGroup;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature set Prefs Container"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
