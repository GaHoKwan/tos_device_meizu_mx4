...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/telephony/PhoneNumberUtils$EccListHandler;,
...
.field private static TCCM_ECC_CALL_PATH:Ljava/lang/String; = null
...
.field private static ecclist_ext:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/telephony/PhoneNumberUtils;->ecclist_ext:Ljava/lang/String;

    .line 179
    const-string v1, "/custom/meizu/config/telephony.xml"

    sput-object v1, Landroid/telephony/PhoneNumberUtils;->TCCM_ECC_CALL_PATH:Ljava/lang/String;
    ...
    .line 1666
    sget-object v1, Landroid/os/BuildExt;->CTA:Ljava/lang/String;
...
.method public static formatNumber(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "lixuan@Comm.Telephony.BugFixFlyme modify for restrictions on the number dial pad format"
...
.method public static getNumberFromIntent(Landroid/content/Intent;Landroid/content/Context;)Ljava/lang/String;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "lixuan@Comm.Telephony.CTS add to get all contacts when it use empty uri to query"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public static isEmergencyNumber(Ljava/lang/String;)Z
    ...
    const-string v30, "[isEmergencyNumber] number: "
    ...
    .line 1695
    .local v22, "plusNumber":Ljava/lang/String;
    const/16 v18, 0x0

    .line 1696
    .local v18, "numberPlus":Ljava/lang/String;
    const/4 v6, 0x0

    .line 1699
    .local v6, "bSIMInserted":Z
    if-nez p0, :cond_0
    ...
    sget-object v28, Landroid/telephony/PhoneNumberUtils;->TCCM_ECC_CALL_PATH:Ljava/lang/String;
    ...
    .line 1719
    .local v7, "confFile":Ljava/io/File;
    ...
    .line 1721
    sget-object v28, Landroid/telephony/PhoneNumberUtils;->ecclist_ext:Ljava/lang/String;
    ...
    .line 1734
    .local v20, "numbers_ext":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :try_start_0
    ...
    .line 1736
    .local v21, "parser":Ljavax/xml/parsers/SAXParser;
    invoke-virtual/range {v21 .. v21}, Ljavax/xml/parsers/SAXParser;->getXMLReader()Lorg/xml/sax/XMLReader;

    move-result-object v23

    .line 1737
    .local v23, "reader":Lorg/xml/sax/XMLReader;
    new-instance v14, Landroid/telephony/PhoneNumberUtils$EccListHandler;

    invoke-direct {v14}, Landroid/telephony/PhoneNumberUtils$EccListHandler;-><init>()V

    .line 1738
    .local v14, "handler":Landroid/telephony/PhoneNumberUtils$EccListHandler;
    move-object/from16 v0, v23

    invoke-interface {v0, v14}, Lorg/xml/sax/XMLReader;->setContentHandler(Lorg/xml/sax/ContentHandler;)V

    .line 1740
    new-instance v28, Lorg/xml/sax/InputSource;
    ...
    invoke-direct/range {v28 .. v29}, Lorg/xml/sax/InputSource;-><init>(Ljava/io/InputStream;)V
    ...
    .line 1741
    invoke-virtual {v14}, Landroid/telephony/PhoneNumberUtils$EccListHandler;->getemErgencyCallNumbers()Ljava/util/ArrayList;
    :try_end_0
    ...
    .end local v14    # "handler":Landroid/telephony/PhoneNumberUtils$EccListHandler;
    .end local v21    # "parser":Ljavax/xml/parsers/SAXParser;
    .end local v23    # "reader":Lorg/xml/sax/XMLReader;
    :goto_2
    ...
    sput-object v28, Landroid/telephony/PhoneNumberUtils;->ecclist_ext:Ljava/lang/String;
    ...
    .line 1768
    .end local v16    # "i$":Ljava/util/Iterator;
    .end local v20    # "numbers_ext":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v24    # "sb":Ljava/lang/StringBuffer;
    :cond_8
    const/16 v28, 0x2
    ...
    .line 1769
    .local v10, "emergencyCTAList":[Ljava/lang/String;
    move-object v4, v10
    ...
    const-string v29, "[isEmergencyNumber] CTA list: return true"
    ...
    const-string v30, "[isEmergencyNumber] ril.ecclist: "
    ...
    const-string v29, "[isEmergencyNumber] ril.ecclist: return true"
    ...
    .line 1799
    :cond_f
    const-string/jumbo v28, "ril.ecclist2"
    ...
    const-string v30, "[isEmergencyNumber] ril.ecclist2: "
    ...
    const-string v29, "[isEmergencyNumber] ril.ecclist2: return true"
    ...
    .line 1816
    :cond_13
    const-string/jumbo v28, "ril.ecclist3"
    ...
    const-string v29, "[isEmergencyNumber] ril.ecclist3: return true"
    ...
    .line 1832
    :cond_17
    const-string/jumbo v28, "ril.ecclist4"
    ...
    const-string v29, "[isEmergencyNumber] ril.ecclist4: return true"
    ...
    .line 1849
    sget-object v28, Landroid/telephony/PhoneNumberUtils;->mPhoneNumberExt:Lcom/mediatek/common/telephony/IPhoneNumberExt;
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/mediatek/common/telephony/IPhoneNumberExt;->isCustomizedEmergencyNumber(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1854
    .local v12, "emergencyNumList":[Ljava/lang/String;
    const-string v28, "PhoneNumberUtils"

    const-string v29, "[isEmergencyNumber] no sim card"
    ...
    .line 1857
    .local v5, "array":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    const-string v28, "190"
    ...
    .line 1872
    .end local v5    # "array":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_1d
    array-length v9, v12
    ...
    const-string v29, "[isEmergencyNumber] no sim ecclist: return true"
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/mediatek/common/telephony/IPhoneNumberExt;->isCustomizedEmergencyNumberExt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1900
    .end local v9    # "eccNo":I
    .end local v12    # "emergencyNumList":[Ljava/lang/String;
    .end local v15    # "i":I
    :cond_21
    const/16 v28, 0x0
...
.method public static mzextractNetworkPortion(Ljava/lang/String;Z)Ljava/lang/String;
    .locals 7
    .param p0, "phoneNumber"    # Ljava/lang/String;
    .param p1, "standForPostDial"    # Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "lixuan@Comm.Telephony.Feature add mz need show just what uri is, so standForPostDial if need"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public static mznormalizeNumber(Ljava/lang/String;Z)Ljava/lang/String;
    .locals 6
    .param p0, "phoneNumber"    # Ljava/lang/String;
    .param p1, "convertKeypadLettersToDigits"    # Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "lixuan@Comm.Telephony.Feature add mz letters can not be converted into digital"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
