...
.field private static final DEFAULT_SHADOW_OFFSETY:I = 0x2
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Featrue add DEFAULT_SHADOW_OFFSETY"
...
.field private static final DEFAULT_SHADOW_RADIUS:I = 0x3
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add DEFAULT_SHADOW_RADIUS"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field

.field private static final DEFAULT_STROKE_COLOR:I = 0x1a000000
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Featrue add DEFAULT_STROKE_COLOR"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private static final DEFAULT_STROKE_RADIUS:I = 0x1
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add DEFAULT_STROKE_RADIUS"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private static final SHADOW_ALPHA_VALUE:I = 0x34
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add SHADOW_ALPHA_VALUE"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field

.field private static final STROKE_ALPHA_VALUE:I = 0x34
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add STROKE_ALPHA_VALUE"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private mOriginalDrawable:Landroid/graphics/drawable/Drawable;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add tmOriginalDrawable"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private mStrokePaint:Landroid/graphics/Paint;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Featrue add mStrokePaint"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field private mWithShadow:Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add mWithShadow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field

.field private mWithStroke:Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Featrue add mWithStroke"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 191
    iput-boolean v1, p0, Landroid/widget/ImageView;->mWithStroke:Z

    .line 197
    iput-object v2, p0, Landroid/widget/ImageView;->mStrokePaint:Landroid/graphics/Paint;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Featrue add to init mWithShadow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 191
    iput-boolean v6, p0, Landroid/widget/ImageView;->mWithStroke:Z

    .line 197
    iput-object v8, p0, Landroid/widget/ImageView;->mStrokePaint:Landroid/graphics/Paint;
...
.method public static createShadowDrawable(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Feature.add to exchangce Drawable to Drawable with shadow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1422
    .local v8, "mapBitmap":Landroid/graphics/Bitmap;
    const/4 v9, 0x0
    ...
    invoke-static {v7, v6, v13}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v2, v13, v14}, Landroid/graphics/BlurMaskFilter;-><init>(FLandroid/graphics/BlurMaskFilter$Blur;)V

    .line 1437
    .local v2, "blurFilterStroke":Landroid/graphics/BlurMaskFilter;
    invoke-virtual {v11, v2}, Landroid/graphics/Paint;->setMaskFilter(Landroid/graphics/MaskFilter;)Landroid/graphics/MaskFilter;

    .line 1438
    invoke-virtual {v8, v11, v10}, Landroid/graphics/Bitmap;->extractAlpha(Landroid/graphics/Paint;[I)Landroid/graphics/Bitmap;

    move-result-object v12

    .line 1439
    .local v12, "strokeBitmap":Landroid/graphics/Bitmap;
    const/16 v13, 0x34
    ...
    invoke-virtual {v3, v12, v13, v14, v1}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v3, v8, v13, v14, v15}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-direct {v9, v0, v5}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V

    .line 1452
    .restart local v9    # "newDrawable":Landroid/graphics/drawable/BitmapDrawable;
    const/4 v13, 0x0

    const/4 v14, 0x0

    invoke-virtual {v9, v13, v14, v7, v6}, Landroid/graphics/drawable/BitmapDrawable;->setBounds(IIII)V

    .line 1454
    .end local v1    # "bitmapPaint":Landroid/graphics/Paint;
    .end local v2    # "blurFilterStroke":Landroid/graphics/BlurMaskFilter;
    .end local v3    # "canvas":Landroid/graphics/Canvas;
    .end local v4    # "color":I
    .end local v5    # "createBitmap":Landroid/graphics/Bitmap;
    .end local v6    # "createHeight":I
    .end local v7    # "createWidth":I
    .end local v10    # "offsetXY":[I
    .end local v11    # "paint":Landroid/graphics/Paint;
    .end local v12    # "strokeBitmap":Landroid/graphics/Bitmap;
    :cond_0
    if-nez v9, :cond_1
...
.method private static drawable2Bitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature.add to changce Drawable to bitmap"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method private setStrokePaint()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Feature.set the stroke paint"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation

    .prologue
    .line 1518
    iget-object v0, p0, Landroid/widget/ImageView;->mStrokePaint:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/widget/ImageView;->mStrokePaint:Landroid/graphics/Paint;
...
.method private updateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue add to create shadow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Feature. set the rect stroke"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1159
    :goto_1
    iget-boolean v0, p0, Landroid/widget/ImageView;->mWithStroke:Z
    ...
    .line 1163
    iget v9, p0, Landroid/widget/ImageView;->mScrollX:I

    .line 1164
    .local v9, "strokeScrollX":I
    iget v10, p0, Landroid/widget/ImageView;->mScrollY:I

    .line 1165
    .local v10, "strokeScrollY":I
    iget v0, p0, Landroid/widget/ImageView;->mPaddingLeft:I
    ...
    iget v0, p0, Landroid/widget/ImageView;->mRight:I

    add-int/2addr v0, v9

    iget v3, p0, Landroid/widget/ImageView;->mLeft:I
    ...
    iget v0, p0, Landroid/widget/ImageView;->mBottom:I

    add-int/2addr v0, v10

    iget v4, p0, Landroid/widget/ImageView;->mTop:I
    ...
    iget-object v5, p0, Landroid/widget/ImageView;->mStrokePaint:Landroid/graphics/Paint;
    ...
    .line 1138
    .end local v9    # "strokeScrollX":I
    .end local v10    # "strokeScrollY":I
    :cond_2
    ...
    .line 1142
    iget v7, p0, Landroid/widget/ImageView;->mScrollX:I

    .line 1143
    .local v7, "scrollX":I
    iget v8, p0, Landroid/widget/ImageView;->mScrollY:I
    ...
    iget v2, p0, Landroid/widget/ImageView;->mRight:I
    ...
    iget v3, p0, Landroid/widget/ImageView;->mBottom:I
...
.method public setWithRectStroke(Z)V
    .locals 1
    .param p1, "isWithStroke"    # Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiayu@SDK.Feature.set the rect stroke"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    ...
    .prologue
    .line 1506
    iput-boolean p1, p0, Landroid/widget/ImageView;->mWithStroke:Z
    ...
    .line 1508
    invoke-direct {p0}, Landroid/widget/ImageView;->setStrokePaint()V
...
.method public setWithShadow(Z)V
    .locals 1
    .param p1, "withShadow"    # Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature.add to set imageview with shadow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
