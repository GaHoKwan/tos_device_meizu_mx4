...
.field private mPackageConfigHelper:Landroid/content/res/flymetheme/PackageConfigHelper;

.field private mPackageName:Ljava/lang/String;

.field private mZipManager:Landroid/content/res/flymetheme/ZipManager;
...
.method public constructor <init>(Ljava/lang/String;Landroid/content/res/Resources;)V
    ...
    iput-object v0, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;

    .line 39
    new-instance v0, Landroid/content/res/flymetheme/PackageConfigHelper;

    invoke-direct {v0, p0}, Landroid/content/res/flymetheme/PackageConfigHelper;-><init>(Landroid/content/res/flymetheme/FlymeThemeResource;)V

    iput-object v0, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mPackageConfigHelper:Landroid/content/res/flymetheme/PackageConfigHelper;

    .line 40
    iput-object p2, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mOwner:Landroid/content/res/Resources;

    .line 41
    iget-object v0, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;

    invoke-static {}, Landroid/content/res/flymetheme/FlymeThemeResource;->getSystemThemeManager()Landroid/content/res/flymetheme/ZipManager;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/content/res/flymetheme/ZipManager;->setSystemThemeManager(Landroid/content/res/flymetheme/ZipManager;)V
...
.method public static get3rdPartThemeIcon(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    .line 141
    .local v1, "sysZipThemeManager":Landroid/content/res/flymetheme/ZipManager;
    if-eqz v1, :cond_0

    .line 142
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromIcon(Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
...
.method public static getDefaultActivityIcon()Landroid/graphics/Bitmap;
    ...
    .line 190
    .local v4, "sysZipThemeManager":Landroid/content/res/flymetheme/ZipManager;
    if-eqz v4, :cond_0
    ...
    invoke-virtual {v4, v2, v5}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromIcon(Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
...
.method private static getSystemThemeManager()Landroid/content/res/flymetheme/ZipManager;
    .locals 2
    ...
    .line 48
    iget-object v1, v0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;
...
.method public static getThemeIcon(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 151
    .local v5, "sysZipThemeManager":Landroid/content/res/flymetheme/ZipManager;
    if-eqz v5, :cond_0
    ...
    invoke-virtual {v5, v3, v6}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromIcon(Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
...
.method private parseColorsFromXml(Ljava/io/InputStream;)V
    ...
    iget-object v3, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mPackageConfigHelper:Landroid/content/res/flymetheme/PackageConfigHelper;
...
.method public getThemeFileStream(Ljava/lang/String;ZLandroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    .line 210
    iget-object v3, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;

    invoke-virtual {v3, p1, p3}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromFramework(Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    invoke-virtual {v3, v4, v0, p3}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromPackage(Ljava/lang/String;Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    .line 216
    .local v2, "sysThemeManager":Landroid/content/res/flymetheme/ZipManager;
    if-eqz v2, :cond_0
    ...
    .end local v2    # "sysThemeManager":Landroid/content/res/flymetheme/ZipManager;
    :cond_3
    iget-object v3, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;

    iget-object v4, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mPackageName:Ljava/lang/String;

    invoke-virtual {v3, v4, p1, p3}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromPackage(Ljava/lang/String;Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
...
.method public load()V
    ...
    .line 127
    iget-object v1, p0, Landroid/content/res/flymetheme/FlymeThemeResource;->mZipManager:Landroid/content/res/flymetheme/ZipManager;

    const-string/jumbo v2, "theme_values.xml"

    invoke-virtual {v1, v2, v4}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromFramework(Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/content/res/flymetheme/ZipManager;->getStreamFromPackage(Ljava/lang/String;Ljava/lang/String;Landroid/util/TypedValue;)Ljava/io/InputStream;
...
.method public reset()V
    ...
    invoke-virtual {v0}, Landroid/content/res/flymetheme/ZipManager;->clean()V
