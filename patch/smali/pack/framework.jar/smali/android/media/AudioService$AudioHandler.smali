...
.method private onRingModeChangedEffectMusic(I)V
    .locals 8
    ...
    invoke-static {v5}, Landroid/media/AudioService;->access$4100(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;

    move-result-object v5

    aget-object v5, v5, v4

    invoke-virtual {v5}, Landroid/media/AudioService$VolumeStreamState;->setAllIndexesToMin()V
    ...
    invoke-direct {p0, v5}, Landroid/media/AudioService$AudioHandler;->setAllVolumes(Landroid/media/AudioService$VolumeStreamState;)V
    ...
    # invokes: Landroid/media/AudioService;->broadcastRingerMode(I)V
    invoke-static {v5, p1}, Landroid/media/AudioService;->access$5300(Landroid/media/AudioService;I)V
    ...
    invoke-virtual {v6, v1}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(I)Ljava/lang/String;
    ...
    invoke-static {v5, v6, v4, v4}, Landroid/media/AudioService;->access$4000(Landroid/media/AudioService;III)I
    ...
    invoke-static {v5, v4, v2, v1, v7}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;IIIZ)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static/range {v18 .. v18}, Landroid/media/AudioService$VolumeStreamState;->access$5700(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-direct {v0, v1}, Landroid/media/AudioService$AudioHandler;->onRingModeChangedEffectMusic(I)V
