...
.field public static final SHOW_AS_ACTION_WITH_TEXT_ALWAYS:I = 0x10
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "CJY@SDK.Featrue.add SHOW_AS_ACTION_WITH_TEXT_ALWAYS"
...
.field public static final SHOW_GRAVITY_CENTER:I = 0x2
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "CJY@SDK.Featrue.add SHOW_GRAVITY_CENTER"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field public static final SHOW_GRAVITY_LEFT:I = 0x1
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "CJY@SDK.Featrue.add SHOW_GRAVITY_LEFT"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.field public static final SHOW_GRAVITY_RIGHT:I = 0x4
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "CJY@SDK.Featrue.add SHOW_GRAVITY_RIGHT"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
