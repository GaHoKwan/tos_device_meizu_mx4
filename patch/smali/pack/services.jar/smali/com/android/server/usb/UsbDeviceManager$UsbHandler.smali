...
# static fields
.field private static final MTP_MODE:I = 0x1

.field private static final PTP_MODE:I
...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    iput-object v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSecurityChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2600(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2902(Lcom/android/server/usb/UsbDeviceManager;Z)Z

    .line 942
    const-string v6, ""

    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3002(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3302(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1001
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3002(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    const-string v7, "mz_show_mtp_notification"
    ...
    new-instance v9, Lcom/android/server/usb/UsbDeviceManager$MtpSettingsObserver;

    invoke-direct {v9, p1}, Lcom/android/server/usb/UsbDeviceManager$MtpSettingsObserver;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$3500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/os/UEventObserver;
    ...
    invoke-static {v6, v7}, Lcom/android/server/usb/UsbDeviceManager;->access$3200(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic access$2500(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    .param p1, "x1"    # Z
...
.method private cancelMtpNotification(Z)V
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$3900(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
...
.method private generatePI(I)Landroid/app/PendingIntent;
    .locals 6
    .param p1, "mode"    # I
    ...
    const-string v2, "com.meizu.mode.ptp"
    ...
    const-string v2, "com.meizu.mode.mtp"
...
.method private setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    const-string v8, "setEnabledFunctions - functions: "
    ...
    const-string v8, "setEnabledFunctions - mDefaultFunctions: "
    ...
    const-string v8, "setEnabledFunctions - mCurrentFunctions: "
    ...
    const-string v8, "setEnabledFunctions - mSettingFunction: "
    ...
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$3300(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    const-string v7, "setEnabledFunctions - [Disable USB Charging]"

    invoke-static {v6, v7}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1277
    const-string v6, "sys.usb.charging"
    ...
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$3600(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string v8, ", mHwDisconnected:"
    ...
    const-string v7, "Do not set sys.usb.bicr=no again!!!"
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingFunction:Ljava/lang/String;
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3300(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$4000(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    iget-object v6, v6, Lcom/android/server/usb/UsbDeviceManager;->mDsg:Landroid/os/DeviceStateManager;
    ...
    invoke-virtual {v6, v7}, Landroid/os/DeviceStateManager;->doCheckState(I)I
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingFunction:Ljava/lang/String;
    invoke-static {v5, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$3302(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3100(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {v5, v0}, Lcom/android/server/usb/UsbDeviceManager;->access$3002(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v7, "Write port_str="
    ...
    .line 1363
    const-string v5, "/sys/class/android_usb/android0/f_acm/port_index"

    invoke-direct {p0, v5, v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->writeFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v5, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v7, "setEnabledFunctions1 - [Disable USB BICR]"

    invoke-static {v6, v7}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1287
    const-string v6, "sys.usb.bicr"
    ...
    const-string v7, "setEnabledFunctions2 - [Disable USB BICR]"
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3200(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingFunction:Ljava/lang/String;
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3300(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->processOemUsbOverride(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v6, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$2600(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingFunction:Ljava/lang/String;
    invoke-static {v6, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$3302(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3100(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "sys.usb.acm_idx="
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {v6, v0}, Lcom/android/server/usb/UsbDeviceManager;->access$3002(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "Write port_str="
    ...
    invoke-direct {p0, v6, v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->writeFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "else setEnabledFunctions, functions: "
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3200(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v6}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->validPortNum(Ljava/lang/String;)I
    ...
    invoke-static {v6, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$3602(Lcom/android/server/usb/UsbDeviceManager;Z)Z
...
.method private showNotification(Landroid/content/res/Resources;III)V
    .locals 14
    ...
    .line 1989
    invoke-virtual/range {p1 .. p2}, Landroid/content/res/Resources;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 1992
    .local v8, "mtpDrawableId":I
    const/4 v11, 0x0

    .line 1993
    .local v11, "ptpDrawableId":I
    const/4 v1, 0x1
    ...
    iput-object v1, v9, Landroid/app/Notification;->sound:Landroid/net/Uri;
    ...
    invoke-virtual {v13, v1, v12}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    .line 2016
    const v1, 0x1020331

    invoke-virtual {v13, v1, v7}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    .line 2017
    const v1, 0x1020334

    invoke-virtual {v13, v1, v8}, Landroid/widget/RemoteViews;->setImageViewResource(II)V

    .line 2018
    const v1, 0x1020333

    invoke-virtual {v13, v1, v11}, Landroid/widget/RemoteViews;->setImageViewResource(II)V

    .line 2019
    const v1, 0x102032f

    invoke-virtual {v13, v1, v10}, Landroid/widget/RemoteViews;->setOnClickPendingIntent(ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->generatePI(I)Landroid/app/PendingIntent;
    ...
    .line 2022
    iput-object v13, v9, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;

    .line 2023
    iget-object v1, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;

    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mNotificationManager:Landroid/app/NotificationManager;
    invoke-static {v1}, Lcom/android/server/usb/UsbDeviceManager;->access$3900(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    invoke-virtual {v1, v2, v0, v9, v4}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    .end local v13    # "views":Landroid/widget/RemoteViews;
    :cond_0
    const v8, 0x1080637
...
.method private updateAdbNotification()V
    ...
    iput v3, v0, Landroid/app/NotificationExt;->notificationIcon:I
...
.method private updateCurrentAccessory()V
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$4200(Lcom/android/server/usb/UsbDeviceManager;)[Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$4300(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    invoke-static {v0, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$4202(Lcom/android/server/usb/UsbDeviceManager;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private updateUsbAudioDeviceState(Ljava/lang/String;)V
    ...
    const-string v10, "/proc/asound/pcm"
    ...
    const-string v10, "(\\d+)[-](\\d+): USB Audio :[^:]*: playback"
    ...
    .line 1630
    .local v3, "expression":Ljava/util/regex/Pattern;
    const-string v9, ""
    ...
    .end local v3    # "expression":Ljava/util/regex/Pattern;
    ...
    const-string v10, "android.intent.action.USB_AUDIO_DEVICE_PLUG"
    ...
    const-string v12, "sendStickyBroadcastAsUser ACTION_USB_AUDIO_DEVICE_PLUG state = "
    ...
    invoke-static {v10, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$4502(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    const-string v11, "/proc/asound/pcm file not found"
...
.method private updateUsbNotification()V
    ...
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$4700(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string v1, "mz_show_mtp_notification"
    ...
    .line 1937
    .local v13, "showMtpNotification":Z
    :goto_2
    const v0, 0x1040473
    ...
    invoke-direct {p0, v12, v7, v9, v0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->showNotification(Landroid/content/res/Resources;III)V
    ...
    .end local v13    # "showMtpNotification":Z
    ...
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$4800(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    .restart local v13    # "showMtpNotification":Z
    ...
    .line 1958
    invoke-virtual {v12, v9}, Landroid/content/res/Resources;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 1969
    iput-object v14, v10, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v10, v0, v14, v8, v11}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v7, v10}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$4600(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .line 1731
    :pswitch_3
    invoke-direct {p0, v8}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->cancelMtpNotification(Z)V
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mAcmPortIdx:Ljava/lang/String;
    invoke-static {v7, v10}, Lcom/android/server/usb/UsbDeviceManager;->access$3002(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$4602(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mIsUserSwitch:Z
    invoke-static {v7, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$4602(Lcom/android/server/usb/UsbDeviceManager;Z)Z

    .line 1775
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;

    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mMtpAskDisconnect:Z
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$3700(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    invoke-static {v7, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$3702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mDebuggingManager:Lcom/android/server/usb/UsbDebuggingManager;
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$3800(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
