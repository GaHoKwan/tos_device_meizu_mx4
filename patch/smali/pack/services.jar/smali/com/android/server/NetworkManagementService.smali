...
.field private static final NET_TYPE_MOBILE:I = 0x0
...
.field private mAllowMobileNetLock:Ljava/lang/Object;
...
.field private mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mAllowMobileNetLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    .prologue
    .line 2520
    iget-object v3, p0, Lcom/android/server/NetworkManagementService;->mAllowMobileNetLock:Ljava/lang/Object;

    monitor-enter v3

    .line 2521
    :try_start_0
    const-string v2, "UID allow mobile net : ["

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    .line 2522
    iget-object v2, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
    ...
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
...
.method private ignoreFirewallUidRule_mobile(IZI)Z
    .locals 7
    .param p1, "uid"    # I
    .param p2, "allow"    # Z
    ...
    .line 2490
    :cond_0
    iget-object v4, p0, Lcom/android/server/NetworkManagementService;->mAllowMobileNetLock:Ljava/lang/Object;

    monitor-enter v4

    .line 2491
    :try_start_0
    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
    ...
    const-string v6, "setFirewallUidRule_mobile uid "
    ...
    .line 2499
    iget-object v3, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
...
.method private init()V
    ...
    const-string v5, "reject mobile net"
    ...
    .line 2513
    .local v2, "uidAllowMobileNet":Landroid/util/SparseBooleanArray;
    new-instance v3, Landroid/util/SparseBooleanArray;

    invoke-direct {v3}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v3, p0, Lcom/android/server/NetworkManagementService;->mUidAllowMobileNet:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/android/server/NetworkManagementService;->setFirewallUidChainRule(IIZ)V
    ...
    .line 2518
    .end local v0    # "i":I
    .end local v2    # "uidAllowMobileNet":Landroid/util/SparseBooleanArray;
    :cond_0
    return-void
.end method
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1928
    invoke-direct {p0, p2}, Lcom/android/server/NetworkManagementService;->dump(Ljava/io/PrintWriter;)V
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "yuwenjie@wireless.BT.OPP, 2.4G/5G  selector"
    ...
    .local v2, "hiddenSSid":Ljava/lang/String;
    :goto_1
    iget v4, p1, Landroid/net/wifi/WifiConfiguration;->BandMode:I
