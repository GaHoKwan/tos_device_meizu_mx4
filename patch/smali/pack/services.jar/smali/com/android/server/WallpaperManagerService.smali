...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/WallpaperManagerService$WallpaperDataInjector;,
        Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;,
...
.field private mInjector:Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1784
    new-instance v0, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;

    invoke-direct {v0, p0}, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;-><init>(Lcom/android/server/WallpaperManagerService;)V

    iput-object v0, p0, Lcom/android/server/WallpaperManagerService;->mInjector:Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;
    ...
    .line 528
    iget-object v0, p0, Lcom/android/server/WallpaperManagerService;->mInjector:Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;

    # invokes: Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;->loadSettingsOfLockWallpaperLocked(I)V
    invoke-static {v0, v3}, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;->access$800(Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;I)V
...
.method static synthetic access$1000(Lcom/android/server/WallpaperManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$1200(Lcom/android/server/WallpaperManagerService;)Landroid/content/Intent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
...
.method static synthetic access$1300(Lcom/android/server/WallpaperManagerService;I)Lcom/android/internal/util/JournaledFile;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 100
    invoke-direct {p0, p1}, Lcom/android/server/WallpaperManagerService;->makeJournaledFile(I)Lcom/android/internal/util/JournaledFile;
...
.method static synthetic access$1400(Lcom/android/server/WallpaperManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
...
.method static synthetic access$200(Lcom/android/server/WallpaperManagerService;)Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
...
.method static synthetic access$500(Lcom/android/server/WallpaperManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
...
.method static synthetic access$902(Lcom/android/server/WallpaperManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/WallpaperManagerService;
    .param p1, "x1"    # Z
...
.method private loadSettingsLocked(I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "modify for set fullscreen wallpaper"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/WallpaperManagerService$WallpaperData;-><init>(Lcom/android/server/WallpaperManagerService;I)V
...
.method public getLockWallpaper(Landroid/app/IWallpaperManagerCallback;Landroid/os/Bundle;)Landroid/os/ParcelFileDescriptor;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "yfy@SHELL.WallpaperManagerService.Feature modify for getting lock wallpaper"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;->getLockWallpaper(Landroid/app/IWallpaperManagerCallback;Landroid/os/Bundle;)Landroid/os/ParcelFileDescriptor;
...
.method onRemoveUser(I)V
    ...
    .line 655
    iget-object v2, p0, Lcom/android/server/WallpaperManagerService;->mInjector:Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;

    invoke-virtual {v2, p1}, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;->onRemoveUser(I)V
...
.method public setLockWallpaper(Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "yfy@SHELL.WallpaperManagerService.Feature modify for setting lock wallpaper"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/WallpaperManagerService$LockWallpaperInjector;->setLockWallpaper(Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public setSmartWallpaperTarget(Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "Globals injector to get wallpaper target PFD"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
