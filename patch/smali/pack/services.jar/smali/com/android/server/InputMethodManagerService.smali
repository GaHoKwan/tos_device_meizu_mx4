...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput v0, p0, Lcom/android/server/InputMethodManagerService;->mMeizuFlags:I
...
.method private containsGoogleVoice(Ljava/util/List;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private needsToShowImeSwitchOngoingNotification()Z
    ...
    invoke-direct {v0, v6}, Lcom/android/server/InputMethodManagerService;->containsGoogleVoice(Ljava/util/List;)Z
...
.method private showInputMethodMenuInternal(Z)V
    ...
    .prologue
    .line 2835
    sget-boolean v20, Lcom/android/server/InputMethodManagerService;->DEBUG:Z

    if-eqz v20, :cond_0

    const-string v20, "InputMethodManagerService"

    const-string v21, "Show switching menu"
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->getSelectedInputMethod()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, v15}, Lcom/android/server/InputMethodManagerService$InputMethodAndSubtypeListManager;->getSortedInputMethodAndSubtypeList(ZZZ)Ljava/util/List;

    move-result-object v12

    .line 2857
    .local v12, "imList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    const/16 v20, -0x1
    ...
    check-cast v16, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;

    .line 2872
    .local v16, "item":Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    move-object/from16 v0, p0
    ...
    .line 2883
    .end local v16    # "item":Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    :cond_8
    const/16 v20, 0x0

    sget-object v22, Lcom/android/internal/R$styleable;->DialogPreference:[I
    ...
    invoke-direct {v6, v8, v0, v12, v7}, Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;-><init>(Landroid/content/Context;ILjava/util/List;I)V
    ...
    const-string v22, "Select input method"
    ...
    .end local v11    # "i":I
    .end local v12    # "imList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;Z)V
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/internal/inputmethod/InputMethodUtils;->isInternationalAndIMEIntl(Ljava/lang/String;)Z
    ...
    .line 2732
    :cond_5
    const-string v17, "com.baidu.input_mz/com.meizu.input.MzInputService"
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    iget-object v10, v7, Lcom/android/server/InputMethodManagerService$ClientState;->client:Lcom/android/internal/view/IInputMethodClient;
    ...
    :goto_9
    invoke-interface {v10, v7}, Lcom/android/internal/view/IInputMethodClient;->onInputShownChanged(Z)V
    :try_end_c
    ...
    const-string v11, "Got RemoteException sending onInputShownChanged("
    ...
    const-string v8, ") notification to pid "
    ...
    invoke-direct {p0, v7}, Lcom/android/server/InputMethodManagerService;->finishInputInternal(Lcom/android/internal/view/IInputMethodClient;)V
