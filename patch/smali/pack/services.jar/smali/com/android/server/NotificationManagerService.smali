...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/NotificationManagerService$NMSInjector;,
...
.field private static final DEBUG_LED_TEST:Z = true
...
.field private mDisableBreathLightInDoNotDisturb:Z
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "lihanguang@SHELL.Feature modify for checking if DoNotDisturbMode is on"
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-boolean v0, v1, Lcom/android/server/NotificationManagerService;->mDisableBreathLightInDoNotDisturb:Z
    ...
    iput-object v0, v1, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    .line 2809
    new-instance v18, Lcom/android/server/NotificationManagerService$8;
    ...
    iput-object v0, v1, Lcom/android/server/NotificationManagerService;->mBreathLightReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v0, v1, Lcom/android/server/NotificationManagerService;->mProximitySensorEnabled:Z

    .line 2950
    new-instance v18, Lcom/android/server/NotificationManagerService$9;
    ...
    iput-object v0, v1, Lcom/android/server/NotificationManagerService;->mProximityListener:Landroid/hardware/SensorEventListener;

    .line 3048
    new-instance v18, Lcom/android/server/NotificationManagerService$10;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/NotificationManagerService$10;-><init>(Lcom/android/server/NotificationManagerService;)V

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/NotificationManagerService;->mDisableProximityRunnable:Ljava/lang/Runnable;

    .line 3059
    new-instance v18, Lcom/android/server/NotificationManagerService$11;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/NotificationManagerService$11;-><init>(Lcom/android/server/NotificationManagerService;)V

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/NotificationManagerService;->mWakeUpScreenRunnable:Ljava/lang/Runnable;
    ...
    .line 1420
    invoke-direct/range {p0 .. p1}, Lcom/android/server/NotificationManagerService;->notiWakeupScreenInit(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/NotificationManagerService;->notiBreathLightInit(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 1476
    const-string v18, "com.mediatek.dm.LAWMO_LOCK"
    ...
    .line 1477
    const-string v18, "com.mediatek.dm.LAWMO_UNLOCK"
    ...
    .line 1478
    const-string v18, "com.mediatek.ppl.NOTIFY_LOCK"
    ...
    .line 1479
    const-string v18, "com.mediatek.ppl.NOTIFY_UNLOCK"
    ...
    .line 1496
    .local v8, "filterBreathLight":Landroid/content/IntentFilter;
    const-string v18, "com.android.server.notification"
    ...
    iget-object v0, v0, Lcom/android/server/NotificationManagerService;->mBreathLightReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1506
    .local v11, "notificationScorerNames":[Ljava/lang/String;
    move-object v3, v11
    ...
    .end local v8    # "filterBreathLight":Landroid/content/IntentFilter;
    .end local v9    # "i$":I
    .end local v10    # "len$":I
    .end local v11    # "notificationScorerNames":[Ljava/lang/String;
    .end local v12    # "pkgFilter":Landroid/content/IntentFilter;
    ...
    const-string v19, "failed to get DM status!"
    ...
    .restart local v8    # "filterBreathLight":Landroid/content/IntentFilter;
    .restart local v9    # "i$":I
    .restart local v10    # "len$":I
    .restart local v11    # "notificationScorerNames":[Ljava/lang/String;
    .restart local v12    # "pkgFilter":Landroid/content/IntentFilter;
    .restart local v16    # "scorerName":Ljava/lang/String;
    .restart local v17    # "sdFilter":Landroid/content/IntentFilter;
    :catch_1
    move-exception v6
...
.method static synthetic access$2300(Lcom/android/server/NotificationManagerService;)Z
    ...
    .prologue
    .line 127
    iget-boolean v0, p0, Lcom/android/server/NotificationManagerService;->mDisableBreathLightInDoNotDisturb:Z
...
.method static synthetic access$2302(Lcom/android/server/NotificationManagerService;Z)Z
    ...
    .prologue
    .line 127
    iput-boolean p1, p0, Lcom/android/server/NotificationManagerService;->mDisableBreathLightInDoNotDisturb:Z
...
.method static synthetic access$2800(Lcom/android/server/NotificationManagerService;Ljava/lang/String;ILandroid/app/Notification;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$3800(Lcom/android/server/NotificationManagerService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$3900(Lcom/android/server/NotificationManagerService;)Landroid/hardware/Sensor;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;

    .prologue
    .line 127
    iget-object v0, p0, Lcom/android/server/NotificationManagerService;->mProximitySensor:Landroid/hardware/Sensor;
...
.method static synthetic access$4000(Lcom/android/server/NotificationManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4100(Lcom/android/server/NotificationManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$4200(Lcom/android/server/NotificationManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$4302(Lcom/android/server/NotificationManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 127
    iput-boolean p1, p0, Lcom/android/server/NotificationManagerService;->mIsLidOpened:Z
...
.method private enableProximityLockLocked()V
    ...
    invoke-virtual {v2, v3, v4, v5}, Lcom/android/server/NotificationManagerService$WorkerHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private notiBreathLightInit(Landroid/content/Context;Lcom/android/server/LightsService;)V
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mButtonLight:Lcom/android/server/LightsService$Light;
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mAlarmManager:Landroid/app/AlarmManager;
...
.method private notiWakeupScreenInit(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mPM:Landroid/os/PowerManager;
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, p0, Lcom/android/server/NotificationManagerService;->mProximityWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 3086
    iget-object v0, p0, Lcom/android/server/NotificationManagerService;->mProximityWakeLock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v0, v3}, Landroid/os/PowerManager$WakeLock;->setReferenceCounted(Z)V

    .line 3089
    iput-boolean v4, p0, Lcom/android/server/NotificationManagerService;->mIsLidOpened:Z

    .line 3090
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->registerLidCallback()V
...
.method private postDelayNotiLightFlashing()V
    ...
    const-string v10, "notification setFlashing delay 5s or 15s mNotificationPulseEnabled = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-boolean v10, p0, Lcom/android/server/NotificationManagerService;->mNotificationPulseEnabled:Z
    ...
    .local v1, "identity":J
    :try_start_1
    iget-object v8, p0, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    if-eqz v8, :cond_0

    .line 2860
    iget-object v8, p0, Lcom/android/server/NotificationManagerService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v9, p0, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
    ...
    const-string v9, "cancel the previous braodcast"
    ...
    .line 2871
    iput-object v5, p0, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
...
.method private registerLidCallback()V
    ...
    :try_start_0
    new-instance v3, Lcom/android/server/NotificationManagerService$12;

    invoke-direct {v3, p0}, Lcom/android/server/NotificationManagerService$12;-><init>(Lcom/android/server/NotificationManagerService;)V
...
.method private updateLightsLocked()V
    ...
    iget-boolean v5, p0, Lcom/android/server/NotificationManagerService;->mDisableBreathLightInDoNotDisturb:Z

    if-nez v5, :cond_1

    iget-boolean v5, p0, Lcom/android/server/NotificationManagerService;->mIsLidOpened:Z
    ...
    const-string v7, ", mDisableBreathLightInDoNotDisturb = "

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v7, p0, Lcom/android/server/NotificationManagerService;->mDisableBreathLightInDoNotDisturb:Z

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v7, ", !mIsLidOpened = "
    ...
    .line 2569
    iget-object v5, p0, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
    ...
    iget-object v6, p0, Lcom/android/server/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
    ...
    .line 2577
    const-string v5, "LedTest"

    const-string v6, "mLedNotification == null..cancel breath light..."
    ...
    const-string v6, "in a call..cancel breath light..."
    ...
    const-string v6, "screen is on..cancel breath light..."
    ...
    .line 2604
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->postDelayNotiLightFlashing()V
...
.method public enqueueToastUnrepeated(Ljava/lang/String;Landroid/app/ITransientNotification;Ljava/lang/CharSequence;I)V
    ...
    const-string v7, "enqueueToast pkg="
    ...
    invoke-direct {v0, v1, v5}, Lcom/android/server/NotificationManagerService;->noteNotificationOp(Ljava/lang/String;I)Z
    ...
    .line 1649
    .restart local v15    # "isSystemToast":Z
    :cond_4
    move-object/from16 v0, p0
...
.method systemReady()V
    ...
    invoke-virtual {v2}, Lcom/android/server/NotificationManagerService$WorkerHandler;->getLooper()Landroid/os/Looper;
