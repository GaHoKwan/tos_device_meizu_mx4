...
.method public getMovedWinPoint()Landroid/graphics/Point;
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowManagerService;->getMovedWinPoint()Landroid/graphics/Point;
...
.method public moveTopAppWinow(III)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/wm/WindowManagerService;->moveTopAppWindow(III)V
...
.method public performDrag(Landroid/view/IWindow;Landroid/os/IBinder;FFFFLandroid/content/ClipData;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "zhangxin@SDK.Session.Feature save surface position and set alpha"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public reportDropResult(Landroid/view/IWindow;Z)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "zhangxin@SDK.Session.Feature start animation after drop"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setMoveWinListener(Landroid/view/IMoveWinCallback;)V
    .locals 1
    .param p1, "callback"    # Landroid/view/IMoveWinCallback;
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "liuyongjie@Shell.Move Window.Feature add move window api"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowManagerService;->setMoveWinListener(Landroid/view/IMoveWinCallback;)V
