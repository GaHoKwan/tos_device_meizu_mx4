...
# instance fields
.field private mAcm:Landroid/content/AccessControlManager;
...
.field private mRealPm:Lcom/android/server/pm/PackageManagerService;
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-static {v1}, Lcom/aliyun/ams/secure/SecureManager;->get(Landroid/content/Context;)Lcom/aliyun/ams/secure/SecureManager;

    move-result-object v11

    .line 662
    .local v11, "secure":Lcom/aliyun/ams/secure/SecureManager;
    if-eqz v11, :cond_0

    .line 663
    invoke-virtual {v11, p1}, Lcom/aliyun/ams/secure/SecureManager;->filterSyncIntent(Landroid/content/Intent;)Z
    ...
    iput v1, v7, Landroid/content/pm/ActivityInfo;->flags:I
    :try_end_1
    ...
    .end local v11    # "secure":Lcom/aliyun/ams/secure/SecureManager;
    :cond_3
    move-object v1, v7
    ...
    .restart local v9    # "isBlocked":Z
    .restart local v10    # "rInfo":Landroid/content/pm/ResolveInfo;
    .restart local v11    # "secure":Lcom/aliyun/ams/secure/SecureManager;
    :cond_5
    const/4 v7, 0x0
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;ILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/ActivityStackSupervisor$Injector;->isFlymePermissionGrantedFromPkg(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor;->mAcm:Landroid/content/AccessControlManager;

    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/android/server/am/ActivityStackSupervisor;->mRealPm:Lcom/android/server/pm/PackageManagerService;

    move-object/from16 v0, p0

    iget-object v10, v0, Lcom/android/server/am/ActivityStackSupervisor;->mContext:Landroid/content/Context;
    ...
    invoke-static/range {v7 .. v13}, Lcom/android/server/am/ActivityStackSupervisor$Injector;->interceptForAccessControl(Landroid/content/AccessControlManager;Lcom/android/server/pm/PackageManagerService;Landroid/content/Intent;Landroid/content/Context;Landroid/content/pm/ActivityInfo;II)Landroid/content/pm/ActivityInfo;
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    .line 1548
    .local v21, "newTaskInfo":Landroid/content/pm/ActivityInfo;
    const/16 v22, 0x0

    .line 1550
    .local v22, "newTaskIntent":Landroid/content/Intent;
    if-eqz p2, :cond_1c
    ...
    .line 1574
    .local v28, "sourceStack":Lcom/android/server/am/ActivityStack;
    :goto_3
    sget-boolean v4, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z
    ...
    .line 1611
    .local v16, "intentActivity":Lcom/android/server/am/ActivityRecord;
    :goto_4
    if-eqz v16, :cond_36
    ...
    invoke-virtual {v4, v15, v6}, Lcom/android/server/am/TaskRecord;->setIntent(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/am/ActivityStack;->topActivity()Lcom/android/server/am/ActivityRecord;
    ...
    .end local v16    # "intentActivity":Lcom/android/server/am/ActivityRecord;
    .end local v17    # "lastStack":Lcom/android/server/am/ActivityStack;
    .end local v21    # "newTaskInfo":Landroid/content/pm/ActivityInfo;
    .end local v22    # "newTaskIntent":Landroid/content/Intent;
    :goto_7
    return v4
    ...
    .end local v28    # "sourceStack":Lcom/android/server/am/ActivityStack;
    :cond_16
    const/4 v4, 0x0
    ...
    .line 1567
    .restart local v21    # "newTaskInfo":Landroid/content/pm/ActivityInfo;
    .restart local v22    # "newTaskIntent":Landroid/content/Intent;
    :cond_1b
    move-object/from16 v0, p2
    ...
    .restart local v28    # "sourceStack":Lcom/android/server/am/ActivityStack;
    goto/16 :goto_3
    ...
    invoke-virtual {v0, v15, v4}, Lcom/android/server/am/ActivityStackSupervisor;->findActivityLocked(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityRecord;
    ...
    .restart local v16    # "intentActivity":Lcom/android/server/am/ActivityRecord;
    .restart local v17    # "lastStack":Lcom/android/server/am/ActivityStack;
    :cond_1e
    ...
    .line 1689
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/am/TaskRecord;->performClearTaskLocked()V
    ...
    .line 1764
    .local v27, "sComponentName":Landroid/content/ComponentName;
    move-object/from16 v0, p1
    ...
    .line 1765
    .local v25, "rComponentName":Landroid/content/ComponentName;
    if-eqz v27, :cond_2e
    ...
    .line 1771
    .end local v25    # "rComponentName":Landroid/content/ComponentName;
    .end local v27    # "sComponentName":Landroid/content/ComponentName;
    :cond_2e
    move-object/from16 v0, p1
    ...
    invoke-virtual {v4, v6}, Landroid/content/Intent;->filterEqualsForTask(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v4, v12, v6, v15, v8}, Lcom/android/server/am/ActivityManagerService;->grantUriPermissionFromIntentLocked(ILjava/lang/String;Landroid/content/Intent;Lcom/android/server/am/UriPermissionOwner;)V
    ...
    .line 1952
    .local v29, "sourceTask":Lcom/android/server/am/TaskRecord;
    move-object/from16 v0, v29
    ...
    .line 2033
    .end local v3    # "targetStack":Lcom/android/server/am/ActivityStack;
    .end local v29    # "sourceTask":Lcom/android/server/am/TaskRecord;
    :cond_51
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/am/ActivityStackSupervisor;->adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v3, v4, v6, v15, v8}, Lcom/android/server/am/ActivityStack;->createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Z)Lcom/android/server/am/TaskRecord;
