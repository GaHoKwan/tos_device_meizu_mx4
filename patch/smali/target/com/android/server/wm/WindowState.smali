...
# static fields
.field private static final MZ_FORCE_SHOW_NAVIGATION:Z

.field private static final MZ_FULLSCREEN_FORCE_HIDE_NAVIGATION:Z = true
...
.field private mPreMovedShowX:I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "liuyongjie@Shell.Move Window.Feature add move window api"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
...
.field private mPreMovedShowY:I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "liuyongjie@Shell.Move Window.Feature add move window api"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/WindowState;->MZ_FORCE_SHOW_NAVIGATION:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput v9, p0, Lcom/android/server/wm/WindowState;->mLayoutOrientation:I

    .line 1731
    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->mIsInMoveMode:Z

    .line 1737
    const/4 v9, 0x1

    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->mIsMovingFinished:Z

    .line 1743
    const/4 v9, -0x1

    iput v9, p0, Lcom/android/server/wm/WindowState;->mBackupFlags:I
    ...
    iput v9, p0, Lcom/android/server/wm/WindowState;->mMovedX:I

    .line 451
    const/4 v9, 0x0

    iput v9, p0, Lcom/android/server/wm/WindowState;->mMovedY:I

    .line 452
    const/4 v9, 0x0

    iput v9, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowX:I

    .line 453
    const/4 v9, 0x0

    iput v9, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowY:I
...
.method private mzFindTopFullscreenOpaqueWindow()Lcom/android/server/wm/WindowState;
    .locals 6
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/WindowState;->mzIndexOf(Lcom/android/server/wm/WindowList;)I
    ...
    :cond_2
    invoke-direct {v2}, Lcom/android/server/wm/WindowState;->mzForceHideNavigationBar()Z
    ...
    .line 1665
    :cond_3
    sget-boolean v3, Lcom/android/server/wm/WindowManagerService;->DEBUG_LAYOUT:Z
    ...
    const-string v5, "yangrui@SDK Found top fullscreen window: "
    ...
    const-string v5, "yangrui@SDK No top fullscreen window: "
...
.method private mzForceHideNavigationBar()Z
    .locals 5
    ...
    .line 1621
    sget-boolean v3, Lcom/android/server/wm/WindowState;->MZ_FORCE_SHOW_NAVIGATION:Z
...
.method private mzIndexOf(Lcom/android/server/wm/WindowList;)I
    .locals 4
    .param p1, "windows"    # Lcom/android/server/wm/WindowList;

    .prologue
    .line 1638
    invoke-virtual {p1, p0}, Lcom/android/server/wm/WindowList;->indexOf(Ljava/lang/Object;)I
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    .line 578
    sget-boolean v1, Lcom/android/server/wm/WindowManagerService;->DEBUG_MOVEWIN:Z
    ...
    const-string v5, "WindowState computeFrameLw>> before move win mFrame == "
    ...
    .line 583
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/WindowState;->isInMovedMode()Z
    ...
    iget v4, v0, Lcom/android/server/wm/WindowState;->mMovedX:I

    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/server/wm/WindowState;->mMovedY:I
    ...
    iget v1, v0, Lcom/android/server/wm/WindowState;->mMovedX:I

    move-object/from16 v0, p0

    iput v1, v0, Lcom/android/server/wm/WindowState;->mPreMovedShowX:I

    .line 592
    move-object/from16 v0, p0

    iget v1, v0, Lcom/android/server/wm/WindowState;->mMovedY:I

    move-object/from16 v0, p0

    iput v1, v0, Lcom/android/server/wm/WindowState;->mPreMovedShowY:I
    ...
    const-string v5, "WindowState computeFrameLw>> final mFrame == "
...
.method public getMovedX()I
    ...
    .prologue
    .line 1774
    iget v0, p0, Lcom/android/server/wm/WindowState;->mMovedX:I
...
.method public getMovedY()I
    ...
    .prologue
    .line 1782
    iget v0, p0, Lcom/android/server/wm/WindowState;->mMovedY:I
...
.method public isInMovedMode()Z
    ...
    .prologue
    .line 1808
    iget-boolean v0, p0, Lcom/android/server/wm/WindowState;->mIsInMoveMode:Z
...
.method public isMovingFinished()Z
    ...
    .prologue
    .line 1816
    iget-boolean v0, p0, Lcom/android/server/wm/WindowState;->mIsMovingFinished:Z
...
.method public moveShownFrame()V
    ...
    .line 1851
    iget v2, p0, Lcom/android/server/wm/WindowState;->mMovedX:I

    iget v3, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowX:I

    sub-int v0, v2, v3

    .line 1852
    .local v0, "offsetX":I
    iget v2, p0, Lcom/android/server/wm/WindowState;->mMovedY:I

    iget v3, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowY:I
...
.method public mzGetInputMethodOffset()I
    .locals 3
    ...
    iget v0, v2, Landroid/view/WindowManager$LayoutParams;->imeOffset:I

    .line 1583
    .local v0, "imeOffset":I
    if-gez v0, :cond_0
    ...
    .line 1588
    invoke-direct {p0}, Lcom/android/server/wm/WindowState;->mzFindTopFullscreenOpaqueWindow()Lcom/android/server/wm/WindowState;

    move-result-object v1

    .line 1589
    .local v1, "top":Lcom/android/server/wm/WindowState;
    if-eqz v1, :cond_1

    if-eq v1, p0, :cond_1

    .line 1590
    invoke-virtual {v1}, Lcom/android/server/wm/WindowState;->mzGetInputMethodOffset()I

    move-result v0

    .line 1593
    .end local v1    # "top":Lcom/android/server/wm/WindowState;
    :cond_1
    return v0
.end method

.method public mzGetNavigationBarSystemFlags(Z)I
    .locals 3
    .param p1, "forceHideOnly"    # Z
    ...
    .line 1607
    :cond_0
    iget v0, v1, Lcom/android/server/wm/WindowState;->mSystemUiVisibility:I

    .line 1608
    .local v0, "flags":I
    invoke-direct {v1}, Lcom/android/server/wm/WindowState;->mzForceHideNavigationBar()Z
...
.method public mzSetIsNavigationBar(Z)V
    .locals 0
    .param p1, "isNavigationBar"    # Z

    .prologue
    .line 1599
    iput-boolean p1, p0, Lcom/android/server/wm/WindowState;->mIsNavigationBar:Z
...
.method public resetMoveWin()V
    ...
    .line 1826
    sget-boolean v0, Lcom/android/server/wm/WindowManagerService;->DEBUG_MOVEWIN:Z
    ...
    .line 1829
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->isInMovedMode()Z
    ...
    .line 1830
    invoke-virtual {p0, v2}, Lcom/android/server/wm/WindowState;->setIsInMovedMode(Z)V

    .line 1831
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/server/wm/WindowState;->setIsMovingFinished(Z)V

    .line 1832
    invoke-virtual {p0, v2}, Lcom/android/server/wm/WindowState;->setMovedX(I)V

    .line 1833
    invoke-virtual {p0, v2}, Lcom/android/server/wm/WindowState;->setMovedY(I)V

    .line 1834
    iput v2, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowX:I

    .line 1835
    iput v2, p0, Lcom/android/server/wm/WindowState;->mPreMovedShowY:I

    .line 1836
    iget v0, p0, Lcom/android/server/wm/WindowState;->mBackupFlags:I
    ...
    iget v1, p0, Lcom/android/server/wm/WindowState;->mBackupFlags:I

    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->flags:I

    .line 1838
    iput v3, p0, Lcom/android/server/wm/WindowState;->mBackupFlags:I
...
.method public setIsInMovedMode(Z)V
    ...
    .prologue
    .line 1792
    iput-boolean p1, p0, Lcom/android/server/wm/WindowState;->mIsInMoveMode:Z
...
.method public setIsMovingFinished(Z)V
    ...
    .prologue
    .line 1800
    iput-boolean p1, p0, Lcom/android/server/wm/WindowState;->mIsMovingFinished:Z
...
.method public setMovedX(I)V
    ...
    .prologue
    .line 1756
    iput p1, p0, Lcom/android/server/wm/WindowState;->mMovedX:I
...
.method public setMovedY(I)V
    ...
    .prologue
    .line 1766
    iput p1, p0, Lcom/android/server/wm/WindowState;->mMovedY:I
