...
.method private allowSendMMS(Lorg/apache/http/HttpRequest;)Z
    .locals 11
    ...
    .local v1, "allowed":Z
    :try_start_0
    instance-of v8, p1, Lorg/apache/http/client/methods/HttpPost;
    ...
    .line 884
    .local v7, "rqln":Lorg/apache/http/RequestLine;
    if-eqz v7, :cond_2
    ...
    const-string v10, "rqln.getMethod:"
    ...
    invoke-static {v2, v8, v9}, Ljava/net/Socket;->allowSendingMMS(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_1
    ...
    .line 891
    .end local v7    # "rqln":Lorg/apache/http/RequestLine;
    :cond_2
    :goto_1
    return v1
    ...
    const-string v10, "getting content type from httppost met exception:"
    ...
    const-string v10, "Socket.allowSendingMMS met exception:"
