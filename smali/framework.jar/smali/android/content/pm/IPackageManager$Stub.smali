...
.field static final TRANSACTION_addGuestComponent:I = 0x65
...
.field static final TRANSACTION_backupData:I = 0x76
...
.field static final TRANSACTION_clearPreferredActivityWithIntentFilter:I = 0x6e

.field static final TRANSACTION_copyForwardLockResource:I = 0x6d
...
.field static final TRANSACTION_getComponentGuestSetting:I = 0x69

.field static final TRANSACTION_getFlagsForUid:I = 0x1c

.field static final TRANSACTION_getGuestSettingsLPrList:I = 0x6c
...
.field static final TRANSACTION_getInternalAppList:I = 0x74

.field static final TRANSACTION_getLastChosenActivity:I = 0x36

.field static final TRANSACTION_getNameForUid:I = 0x1a

.field static final TRANSACTION_getPackageActivateState:I = 0x75

.field static final TRANSACTION_getPackageGids:I = 0x4

.field static final TRANSACTION_getPackageGuestSetting:I = 0x6b

.field static final TRANSACTION_getPackageInfo:I = 0x2

.field static final TRANSACTION_getPackageInfoForVersion:I = 0x73
...
.field static final TRANSACTION_performDexOptPermission:I = 0x6a
...
.field static final TRANSACTION_removeGuestComponent:I = 0x66
...
.field static final TRANSACTION_resetVersion:I = 0x72
...
.field static final TRANSACTION_upadteGuestMode:I = 0x67

.field static final TRANSACTION_updateExternalMediaStatus:I = 0x51

.field static final TRANSACTION_updatePermissions:I = 0x6f

.field static final TRANSACTION_updateVersion:I = 0x70

.field static final TRANSACTION_updatemPowerSavingMode:I = 0x77

.field static final TRANSACTION_verifyPendingInstall:I = 0x5a

.field static final TRANSACTION_verifyVersion:I = 0x71
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 1626
    .local v21, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1632
    .end local v4    # "_arg0":I
    .end local v21    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    :sswitch_6d
    const-string v3, "android.content.pm.IPackageManager"
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->updatePermissions(Ljava/lang/String;)V
    ...
    .line 1668
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->updateVersion()V
    ...
    .line 1675
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->verifyVersion()V
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->resetVersion(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/content/pm/IPackageManager$Stub;->getPackageInfoForVersion(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    .line 1709
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->getInternalAppList()Ljava/util/List;
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->getPackageActivateState(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v4, v5}, Landroid/content/pm/IPackageManager$Stub;->backupData(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->updatemPowerSavingMode(Z)V
    ...
    .line 1748
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->isPowerSavingMode()Z
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->isPackageInWhitelist(Landroid/content/ComponentName;)Z
