...
.field public static final SESSION_STATUS_RUNNING:I = 0x0
...
.method public disconnectLeDevice(IILjava/lang/String;)Z
    .locals 6
    .param p1, "Role"    # I
    .param p2, "ID"    # I
    ...
    const-string v5, "disconnectLeDevice() - Role="
    ...
    const-string/jumbo v5, "unregisterAppById fail, iGatt: "
    ...
    .line 1609
    invoke-interface {v1, p2, p3}, Landroid/bluetooth/IBluetoothGatt;->clientDisconnect(ILjava/lang/String;)V
    ...
    .line 1611
    invoke-interface {v1, p2, p3}, Landroid/bluetooth/IBluetoothGatt;->serverDisconnect(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "unregisterAppById fail"
...
.method public getBtSessionStatus(Landroid/content/Context;)I
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
...
.method public getIdByAddress(ILjava/lang/String;)I
    .locals 5
    .param p1, "Role"    # I
    ...
    .line 1588
    invoke-interface {v1, p1, p2}, Landroid/bluetooth/IBluetoothGatt;->getIdByAddress(ILjava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "getClientIdByAddress fail"
...
.method public getLeDevicesMatchingConnectionStates([I)Ljava/util/List;
    .locals 6
    .param p1, "states"    # [I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    const-string v5, "getLeDevicesMatchingConnectionStates() - states="
    ...
    .restart local v1    # "iGatt":Landroid/bluetooth/IBluetoothGatt;
    :cond_0
    invoke-interface {v1, p1}, Landroid/bluetooth/IBluetoothGatt;->getDevicesMatchingConnectionStates([I)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "getLeDevices fail"
...
.method public setBtSessionStatus(Landroid/content/Context;I)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "status"    # I
