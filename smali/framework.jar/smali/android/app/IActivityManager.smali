...
.field public static final FORCE_KILL_PROCESS:I = 0xc2
...
.field public static final OVERRIDE_PENDING_CUSTOM_TRANSITION_TRANSACTION:I = 0xc0
...
.field public static final SCREENSHOT_TOP_LAYER_BEHIND_KEYGUARD:I = 0xc1
...
.field public static final SET_APPLICATION_ERROR_LISTENER_TRANSACTION:I = 0xc3
...
.method public abstract screenShotTopLayerBehindKeyguard()Landroid/graphics/Bitmap;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setApplicationErrorListener(Landroid/app/IApplicationErrorListener;)V
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.ErrorReport.Feature add for application error report"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
