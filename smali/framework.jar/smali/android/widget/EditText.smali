...
.field private mOnKeyPreImeListener:Landroid/widget/EditText$OnKeyPreImeListener;
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "jiangjunlei@SDK.Feature. add keypreime listener"
...
.method public onKeyPreIme(ILandroid/view/KeyEvent;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiangjunlei@SDK.Feature. add method process keypreime."
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setOnKeyPreImeListener(Landroid/widget/EditText$OnKeyPreImeListener;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiangjunlei@SDK.Feature. add method set keypreime listener."
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
