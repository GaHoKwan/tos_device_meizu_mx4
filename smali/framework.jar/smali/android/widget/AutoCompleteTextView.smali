...
.field private mFilterComplete:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Featrue change popup window style"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1432
    iput-boolean v4, p0, Landroid/widget/AutoCompleteTextView;->mIsMmsFirstFileter:Z

    .line 1437
    iput-boolean v5, p0, Landroid/widget/AutoCompleteTextView;->mFilterComplete:Z
    ...
    invoke-virtual {v2, v5}, Landroid/widget/ListPopupWindow;->setPromptPosition(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/widget/AutoCompleteTextView;->setDropDownPaddingStart(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/widget/AutoCompleteTextView;->setDropDownPaddingEnd(I)V
    ...
    invoke-virtual {p0, v2}, Landroid/widget/AutoCompleteTextView;->setDropDownPaddingTop(I)V

    .line 202
    iget-object v2, p0, Landroid/widget/AutoCompleteTextView;->mPopup:Landroid/widget/ListPopupWindow;

    check-cast v2, Landroid/widget/AutoCompleteTextView$DropdownPopup;
    ...
    invoke-virtual {v2, v3}, Landroid/widget/AutoCompleteTextView$DropdownPopup;->setDivider(Landroid/graphics/drawable/Drawable;)V
...
.method private performCompletion(Landroid/view/View;IJ)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Featrue.add to adjust DropDownList position"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method private updateDropDownForFilter(I)V
    ...
    :cond_2
    :goto_1
    iget-boolean v2, p0, Landroid/widget/AutoCompleteTextView;->mFilterComplete:Z
    ...
    iput-boolean v2, p0, Landroid/widget/AutoCompleteTextView;->mIsMmsFirstFileter:Z

    .line 1018
    :cond_3
    iput-boolean v4, p0, Landroid/widget/AutoCompleteTextView;->mFilterComplete:Z
...
.method public enoughToFilter()Z
    ...
    iget-boolean v0, p0, Landroid/widget/AutoCompleteTextView;->mIsMmsFirstFileter:Z
...
.method public getPopup()Landroid/widget/ListPopupWindow;
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "xiaohongzhi@SDK.Feature.add to return the ListPopupWindow"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public keepInputMethodNeeded(Z)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature.add to set keyboard keep visible or not"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public performFilteringByMms(Ljava/lang/CharSequence;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "jiangjunlei@SDK.Featrue.add "
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    iput-boolean v0, p0, Landroid/widget/AutoCompleteTextView;->mIsMmsFirstFileter:Z

    .line 1445
    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/widget/AutoCompleteTextView;->mFilterComplete:Z
...
.method public setDropDownPaddingEnd(I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature.set ListPopupWindow padding"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setHeaderText(Ljava/lang/String;)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "xiaohongzhi@SDK.Feature.add to set text for the smaller title"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
