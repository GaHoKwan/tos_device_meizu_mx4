...
.field private mCursorOffsetX:I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
...
.field mLastLayoutHeight:I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature add for refresh text display"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroid/widget/Editor;->mHandler:Landroid/os/Handler;

    .line 5108
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Landroid/widget/Editor;->mLastScrollTime:J

    .line 5114
    iput-boolean v2, p0, Landroid/widget/Editor;->mIsInDragSelectionMode:Z

    .line 5131
    iput-boolean v3, p0, Landroid/widget/Editor;->mEnableDragSelection:Z

    .line 5597
    iput v2, p0, Landroid/widget/Editor;->mCursorOffsetX:I
...
.method static synthetic access$1300(Landroid/widget/Editor;)Z
    ...
    .prologue
    .line 134
    invoke-direct {p0}, Landroid/widget/Editor;->isAttached()Z
...
.method static synthetic access$2900(Landroid/widget/Editor;)J
    .locals 2
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$2902(Landroid/widget/Editor;J)J
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # J
...
.method static synthetic access$3000(Landroid/widget/Editor;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3100(Landroid/widget/Editor;)Landroid/widget/Editor$OptionWrapper;
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3900(Landroid/widget/Editor;Landroid/graphics/Rect;Z)V
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # Landroid/graphics/Rect;
    .param p2, "x2"    # Z
...
.method private drawCursor(Landroid/graphics/Canvas;I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "wangying@SDK.TextView.Feature modify for hint padding"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1651
    :cond_0
    iget v2, p0, Landroid/widget/Editor;->mCursorOffsetX:I
...
.method private drawHardwareAccelerated(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature modify for refresh text display"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    .line 1463
    .local v29, "lineRange":J
    invoke-static/range {v29 .. v30}, Landroid/text/TextUtils;->unpackRangeStartFromLong(J)I

    move-result v9

    .line 1464
    .local v9, "firstLine":I
    invoke-static/range {v29 .. v30}, Landroid/text/TextUtils;->unpackRangeEndFromLong(J)I
    ...
    instance-of v4, v0, Landroid/text/RichDynamicLayout;
    ...
    .line 1512
    .local v34, "richDynamicLayout":Landroid/text/RichDynamicLayout;
    const/16 v20, 0x0
    ...
    instance-of v0, v0, Landroid/text/RichDynamicLayout;

    move/from16 v25, v0

    .line 1514
    .local v25, "isRichDynamicLayout":Z
    if-eqz v25, :cond_7

    move-object/from16 v34, p2

    .line 1515
    check-cast v34, Landroid/text/RichDynamicLayout;

    .line 1516
    invoke-virtual/range {v34 .. v34}, Landroid/text/RichDynamicLayout;->getBlockEndLines()[I

    move-result-object v15

    .line 1517
    invoke-virtual/range {v34 .. v34}, Landroid/text/RichDynamicLayout;->getBlockIndices()[I

    move-result-object v17

    .line 1518
    invoke-virtual/range {v34 .. v34}, Landroid/text/RichDynamicLayout;->getNumberOfBlocks()I

    move-result v33

    .line 1519
    invoke-virtual/range {v34 .. v34}, Landroid/text/RichDynamicLayout;->getIndexFirstChangedBlock()I
    ...
    .end local v28    # "line":I
    .end local v31    # "max":F
    .end local v32    # "min":F
    .end local v35    # "right":I
    .end local v36    # "searchStartIndex":I
    .end local v37    # "top":I
    :cond_7
    ...
    .line 1535
    .restart local v14    # "blockEndLine":I
    .restart local v16    # "blockIndex":I
    .restart local v21    # "endOfPreviousBlock":I
    .restart local v23    # "i":I
    .restart local v36    # "searchStartIndex":I
    :cond_8
    const/16 v18, 0x0
    ...
    .restart local v28    # "line":I
    .restart local v31    # "max":F
    .restart local v32    # "min":F
    ...
    invoke-virtual {v0, v1}, Landroid/text/RichDynamicLayout;->setIndexFirstChangedBlock(I)V
    ...
    .end local v25    # "isRichDynamicLayout":Z
    .end local v26    # "layoutHeight":I
    .end local v33    # "numberOfBlocks":I
    .end local v34    # "richDynamicLayout":Landroid/text/RichDynamicLayout;
    .end local v36    # "searchStartIndex":I
    :cond_11
    move-object/from16 v0, p2
...
.method private isAttached()Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature add for fix bug #103671"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method private isPositionVisible(II)Z
    ...
    .line 851
    :cond_0
    instance-of v7, v3, Landroid/widget/AbsListView;

    if-nez v7, :cond_1

    instance-of v7, v3, Landroid/widget/ScrollView;
...
.method private selectCurrentWord()Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature modify for select word"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method private updateCursorPosition(IIIF)V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature modify for cursor display incomplete"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method onSelectionChanged(II)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$SelectionActionModeCallback;->access$4000(Landroid/widget/Editor$SelectionActionModeCallback;)Z
...
.method onTouchUpEvent(Landroid/view/MotionEvent;)V
    ...
    .prologue
    .line 1884
    invoke-virtual {p0, p1}, Landroid/widget/Editor;->onTouchUpEventMz(Landroid/view/MotionEvent;)V
...
.method onTouchUpEventMz(Landroid/view/MotionEvent;)V
    ...
    .line 5426
    new-instance v4, Landroid/widget/Editor$4;

    invoke-direct {v4, p0}, Landroid/widget/Editor$4;-><init>(Landroid/widget/Editor;)V
...
.method public performLongClick(Z)Z
    ...
    .prologue
    .line 928
    invoke-virtual {p0, p1}, Landroid/widget/Editor;->performLongClickMz(Z)Z
...
.method public performLongClickMz(Z)Z
    ...
    .line 5221
    .local v0, "offset":I
    invoke-direct {p0, v0, v0}, Landroid/widget/Editor;->touchPositionIsInSelectionMz(II)Z
...
.method prepareCursorControllers()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->CHANGE_CODE:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature modify for no cursor background"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    invoke-virtual {v4, v5}, Landroid/widget/TextView;->updateBackground(Z)V
...
.method updateCursorsPositions()V
    ...
    .line 1721
    .local v6, "hintLayout":Landroid/text/Layout;
    iget-object v12, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    invoke-virtual {v7, v12}, Landroid/text/Layout;->getLineTop(I)I
    ...
    .line 1734
    .local v5, "fi":Landroid/graphics/Paint$FontMetricsInt;
    ...
    .line 1736
    .local v3, "charTop":I
    iget v12, v5, Landroid/graphics/Paint$FontMetricsInt;->descent:I
    ...
    .line 1741
    :goto_2
    invoke-virtual {v7, v10}, Landroid/text/Layout;->isLevelBoundary(I)Z
    ...
    .line 1749
    :cond_1
    invoke-virtual {v7, v8}, Landroid/text/Layout;->shouldClampCursor(I)Z
    ...
    invoke-direct {p0, v7, v6, v10, v4}, Landroid/widget/Editor;->getPrimaryHorizontal(Landroid/text/Layout;Landroid/text/Layout;IZ)F

    move-result v13

    invoke-direct {p0, v12, v11, v9, v13}, Landroid/widget/Editor;->updateCursorPosition(IIIF)V
    ...
    invoke-virtual {v7, v10, v4}, Landroid/text/Layout;->getSecondaryHorizontal(IZ)F

    move-result v13

    invoke-direct {p0, v12, v9, v1, v13}, Landroid/widget/Editor;->updateCursorPosition(IIIF)V

    .line 1760
    :cond_2
    iget-object v12, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;

    invoke-virtual {v12}, Landroid/widget/TextView;->getHint()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v12}, Landroid/widget/TextView;->getHintPadding()I

    move-result v12

    iget-object v13, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;

    invoke-virtual {v13}, Landroid/widget/TextView;->getCursorWidth()I

    move-result v13

    sub-int/2addr v12, v13

    iput v12, p0, Landroid/widget/Editor;->mCursorOffsetX:I

    goto/16 :goto_0

    .end local v4    # "clamped":Z
    ...
    .line 1765
    .restart local v4    # "clamped":Z
    .restart local v9    # "middle":I
    :cond_7
    iget-object v12, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
