...
.field private mTextViewHeight:I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_FIELD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "wangying@SDK.TextView.Feature add for refresh selection position"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
.end field
...
.method private updatePosition()V
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "wangying@SDK.TextView.Feature modify for fix bug"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
    ...
    iget-object v4, p0, Landroid/widget/Editor$PositionListener;->mTempCoords:[I

    invoke-virtual {v1, v4}, Landroid/widget/TextView;->getLocationInWindow([I)V

    .line 2575
    iget-object v1, p0, Landroid/widget/Editor$PositionListener;->this$0:Landroid/widget/Editor;

    # invokes: Landroid/widget/Editor;->isAttached()Z
    invoke-static {v1}, Landroid/widget/Editor;->access$1300(Landroid/widget/Editor;)Z
    ...
    iget-boolean v1, p0, Landroid/widget/Editor$PositionListener;->mAttached:Z
    ...
    iput v1, p0, Landroid/widget/Editor$PositionListener;->mPositionY:I
