...
.field public static final FLAG_FORCE_TIMEOUT:I = 0x80
...
.field private static final SHOW_VOLUME_PANEL_DELAY:I = 0x1f4
...
# instance fields
.field private delayExpire:Z

.field private handler:Landroid/os/Handler;

.field private hasKeyDownEvent:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 535
    iput-boolean v1, p0, Landroid/media/AudioManager;->hasKeyDownEvent:Z

    .line 536
    iput-boolean v1, p0, Landroid/media/AudioManager;->delayExpire:Z
    ...
    iput-object v0, p0, Landroid/media/AudioManager;->handler:Landroid/os/Handler;
...
.method static synthetic access$002(Landroid/media/AudioManager;Z)Z
    .locals 0
    ...
    .prologue
    .line 53
    iput-boolean p1, p0, Landroid/media/AudioManager;->delayExpire:Z
...
.method static synthetic access$200(Landroid/media/AudioManager;Ljava/lang/String;)Landroid/media/AudioManager$OnAudioFocusChangeListener;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioManager;
...
.method public handleForceTimeout()V
    .locals 3
...
.method public handleKeyDown(Landroid/view/KeyEvent;I)V
    ...
    .line 561
    .local v0, "flags":I
    iget-boolean v5, p0, Landroid/media/AudioManager;->delayExpire:Z

    if-nez v5, :cond_2

    .line 562
    iget-object v5, p0, Landroid/media/AudioManager;->handler:Landroid/os/Handler;
    ...
    .line 566
    iput-boolean v2, p0, Landroid/media/AudioManager;->hasKeyDownEvent:Z
...
.method public handleKeyUp(Landroid/view/KeyEvent;I)V
    ...
    .line 612
    .local v0, "flags":I
    iget-boolean v2, p0, Landroid/media/AudioManager;->hasKeyDownEvent:Z

    if-eqz v2, :cond_0

    .line 613
    iget-boolean v2, p0, Landroid/media/AudioManager;->delayExpire:Z
    ...
    .line 615
    iget-object v2, p0, Landroid/media/AudioManager;->handler:Landroid/os/Handler;

    invoke-virtual {v2, v5}, Landroid/os/Handler;->removeMessages(I)V

    .line 620
    :goto_1
    iput-boolean v5, p0, Landroid/media/AudioManager;->hasKeyDownEvent:Z
    ...
    .line 618
    :cond_2
    iput-boolean v5, p0, Landroid/media/AudioManager;->delayExpire:Z
...
.method public switchBluetoothToDevice(I)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->switchBluetoothToDevice(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in switchBlutoothToDevice"
