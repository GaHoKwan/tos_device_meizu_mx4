...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 379
    iput-boolean v1, p0, Landroid/media/MediaScanner;->mM3uCopingFlg:Z
...
.method static synthetic access$1400(Landroid/media/MediaScanner;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$1600(Landroid/media/MediaScanner;)Landroid/media/MediaScanner$MyMediaScannerClient;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$2200(Landroid/media/MediaScanner;)Landroid/graphics/BitmapFactory$Options;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$2400(Landroid/media/MediaScanner;)Landroid/media/MediaInserter;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$3800(Landroid/media/MediaScanner;)Z
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$3802(Landroid/media/MediaScanner;Z)Z
    .locals 0
    .param p0, "x0"    # Landroid/media/MediaScanner;
    .param p1, "x1"    # Z
...
.method static synthetic access$4000(Landroid/media/MediaScanner;)Z
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$4100(Landroid/media/MediaScanner;)Landroid/net/Uri;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$4300(Landroid/media/MediaScanner;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$4400(Landroid/media/MediaScanner;Ljava/lang/String;Ljava/lang/String;)I
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Ljava/lang/String;
...
.method static synthetic access$4500(Landroid/media/MediaScanner;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$4600(Landroid/media/MediaScanner;)Landroid/drm/DrmManagerClient;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$4602(Landroid/media/MediaScanner;Landroid/drm/DrmManagerClient;)Landroid/drm/DrmManagerClient;
    .locals 0
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    .line 1941
    .local v36, "mediaFileType":Landroid/media/MediaFile$MediaFileType;
    if-nez v36, :cond_11
    ...
    invoke-interface {v2, v0, v3}, Llibcore/io/Os;->access(Ljava/lang/String;I)Z
    :try_end_5
    ...
    .end local v36    # "mediaFileType":Landroid/media/MediaFile$MediaFileType;
    .end local v37    # "num":I
    :catchall_0
    move-exception v2
    ...
    .line 1938
    .local v30, "e1":Llibcore/io/ErrnoException;
    :try_start_7
    const-string v2, "MediaScanner"
    ...
    .line 1941
    .end local v30    # "e1":Llibcore/io/ErrnoException;
    .restart local v36    # "mediaFileType":Landroid/media/MediaFile$MediaFileType;
    :cond_11
    ...
    .line 1954
    .local v29, "e":Llibcore/io/ErrnoException;
    invoke-virtual/range {v29 .. v29}, Llibcore/io/ErrnoException;->printStackTrace()V

    goto :goto_8

    .line 1960
    .end local v29    # "e":Llibcore/io/ErrnoException;
    :cond_12
    move-object/from16 v0, v28
...
.method private processCachedPlaylist(Landroid/database/Cursor;Landroid/content/ContentValues;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    .line 2609
    invoke-direct {p0, v8, v9, v1}, Landroid/media/MediaScanner;->matchEntries(JLjava/lang/String;)Z
    ...
    :cond_1
    iget-object v10, p0, Landroid/media/MediaScanner;->mPlaylistEntries:Ljava/util/ArrayList;
    ...
    .line 2619
    .local v4, "entry":Landroid/media/MediaScanner$PlaylistEntry;
    iget v10, v4, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchlevel:I
    ...
    .line 2622
    const-string/jumbo v10, "play_order"
    ...
    iget-wide v11, v4, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchid:J
    ...
    iget-object v11, p0, Landroid/media/MediaScanner;->mPackageName:Ljava/lang/String;

    move-object/from16 v0, p3

    invoke-interface {v10, v11, v0, p2}, Landroid/content/IContentProvider;->insert(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v11, "RemoteException in MediaScanner.processCachedPlaylist()"

    invoke-static {v10, v11, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 2635
    .end local v3    # "e":Landroid/os/RemoteException;
    .end local v4    # "entry":Landroid/media/MediaScanner$PlaylistEntry;
    :goto_1
    return-void
...
.method private processM3uPlayList(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/database/Cursor;)V
    ...
    invoke-static {v7, v8, v1}, Lcom/mediatek/xlog/Xlog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private processPlayList(Landroid/media/MediaScanner$FileEntry;Landroid/database/Cursor;)V
    ...
    invoke-static {v2, v3, v0, v9}, Landroid/media/MediaScanner$MyMediaScannerClient;->access$4900(Landroid/media/MediaScanner$MyMediaScannerClient;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Z
...
.method public postScanAll(Ljava/util/ArrayList;)V
    ...
    .line 2922
    iget-object v1, p0, Landroid/media/MediaScanner;->mPlaylists:Ljava/util/Map;
...
.method public scanMtpFile(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string/jumbo v5, "scanMtpFile fileType = "
    ...
    invoke-static/range {v32 .. v32}, Landroid/media/MediaFile;->isDrmFileType(I)Z
    ...
    .line 2381
    .local v31, "fileList":Landroid/database/Cursor;
    const/16 v3, 0x1f9
    ...
    .line 2384
    :try_start_1
    new-instance v27, Landroid/media/CueHelper;

    invoke-direct/range {v27 .. v27}, Landroid/media/CueHelper;-><init>()V

    .line 2385
    .local v27, "cue":Landroid/media/CueHelper;
    move-object/from16 v0, v27
    ...
    .line 2386
    invoke-virtual/range {v27 .. v27}, Landroid/media/CueHelper;->getMusicFilePath()Ljava/lang/String;

    move-result-object v35

    .line 2387
    .local v35, "musicFilePath":Ljava/lang/String;
    const/16 v36, 0x0

    .line 2389
    .local v36, "processAsNormal":Z
    if-eqz v35, :cond_5
    ...
    .line 2458
    .end local v27    # "cue":Landroid/media/CueHelper;
    .end local v35    # "musicFilePath":Ljava/lang/String;
    .end local v36    # "processAsNormal":Z
    :cond_7
    :goto_4
    const/4 v3, 0x0
    ...
    .line 2392
    .restart local v27    # "cue":Landroid/media/CueHelper;
    .restart local v35    # "musicFilePath":Ljava/lang/String;
    .restart local v36    # "processAsNormal":Z
    :cond_8
    :try_start_2
    ...
    .line 2393
    .local v34, "musicFile":Ljava/io/File;
    ...
    .line 2402
    .end local v34    # "musicFile":Ljava/io/File;
    :cond_9
    const/16 v16, 0x0
    ...
    .line 2407
    .local v29, "entry":Landroid/media/MediaScanner$FileEntry;
    new-instance v6, Landroid/content/ContentValues;
    ...
    invoke-interface/range {v14 .. v19}, Landroid/content/IContentProvider;->update(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    sget-object v20, Landroid/media/MediaScanner;->FILES_PRESCAN_PROJECTION:[Ljava/lang/String;
    ...
    invoke-interface/range {v17 .. v24}, Landroid/content/IContentProvider;->query(Ljava/lang/String;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/ICancellationSignal;)Landroid/database/Cursor;
    ...
    .end local v27    # "cue":Landroid/media/CueHelper;
    .end local v29    # "entry":Landroid/media/MediaScanner$FileEntry;
    .end local v35    # "musicFilePath":Ljava/lang/String;
    .end local v36    # "processAsNormal":Z
    :catch_1
    move-exception v28
    ...
    iput-boolean v3, v0, Landroid/media/MediaScanner;->mM3uCopingFlg:Z
    ...
    .line 2442
    .restart local v29    # "entry":Landroid/media/MediaScanner$FileEntry;
    if-eqz v29, :cond_7
    ...
    invoke-virtual/range {v17 .. v26}, Landroid/media/MediaScanner$MyMediaScannerClient;->doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    :try_end_5
