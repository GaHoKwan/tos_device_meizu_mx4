...
.method private createSliders()V
    ...
    invoke-direct {v3, p0, v8}, Landroid/view/VolumePanel$StreamControl;-><init>(Landroid/view/VolumePanel;Landroid/view/VolumePanel$1;)V
    ...
    check-cast v6, Landroid/widget/CustomSeekBar;

    iput-object v6, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    .line 569
    iget-object v6, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    invoke-direct {p0, v5}, Landroid/view/VolumePanel;->getStreamMaxVolume(I)I

    move-result v7

    invoke-virtual {v6, v7}, Landroid/widget/CustomSeekBar;->setMax(I)V

    .line 570
    iget-object v6, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    invoke-virtual {v6, p0}, Landroid/widget/CustomSeekBar;->setOnSeekBarChangeListener(Landroid/widget/CustomSeekBar$OnSeekBarChangeListener;)V

    .line 571
    iget-object v6, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    invoke-virtual {v6, v3}, Landroid/widget/CustomSeekBar;->setTag(Ljava/lang/Object;)V
...
.method private updateSlider(Landroid/view/VolumePanel$StreamControl;)V
    ...
    .line 610
    iget-object v1, p1, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;
    ...
    invoke-virtual {v1, v3}, Landroid/widget/CustomSeekBar;->setEnabled(Z)V
    ...
    invoke-virtual {v1, v2}, Landroid/widget/CustomSeekBar;->setEnabled(Z)V
...
.method public onProgressChanged(Landroid/widget/CustomSeekBar;IZ)V
    .locals 4
    .param p1, "seekBar"    # Landroid/widget/CustomSeekBar;
    .param p2, "progress"    # I
    .param p3, "fromUser"    # Z
...
.method protected onShowVolumeChanged(II)V
    ...
    .line 876
    iget-object v5, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    invoke-virtual {v5}, Landroid/widget/CustomSeekBar;->getMax()I
    ...
    invoke-virtual {v5, v1}, Landroid/widget/CustomSeekBar;->setMax(I)V

    .line 880
    :cond_2
    iget-object v5, v3, Landroid/view/VolumePanel$StreamControl;->seekbarView:Landroid/widget/CustomSeekBar;

    invoke-virtual {v5, v0}, Landroid/widget/CustomSeekBar;->setProgress(I)V
    ...
    invoke-virtual {v5, v10}, Landroid/widget/CustomSeekBar;->setEnabled(Z)V
    ...
    invoke-virtual {v5, v8}, Landroid/widget/CustomSeekBar;->setEnabled(Z)V
...
.method public onStopTrackingTouch(Landroid/widget/CustomSeekBar;)V
    ...
    invoke-virtual {p1, v2}, Landroid/widget/CustomSeekBar;->setProgress(I)V
    ...
    :cond_1
    invoke-virtual {p1}, Landroid/widget/CustomSeekBar;->getProgress()I
...
.method protected onVolumeChanged(II)V
    ...
    const-string/jumbo v2, "onVolumeChanged(mActiveStreamType: "
...
.method public postVolumeChanged(II)V
    ...
    const-string v1, "has  message MSG_VOLUME_CHANGED"
