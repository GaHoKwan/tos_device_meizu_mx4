...
.field public static final FEATURE_STARTING_WINDOW:I = 0xb
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "suyouxiong@SDK.Feature. add FEATURE_STARTING_WINDOW"
...
.method private isOutOfBoundsNoSlop(Landroid/content/Context;Landroid/view/MotionEvent;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        ...
        note = "suyouxiong@SDK.Feature.add report if touch on the outside of DocorView ignoring slop"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public isTouchOutOfBounds(Landroid/content/Context;Landroid/view/MotionEvent;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add No matter CloseOnTouchOutside is set false or true, the dialog should be closed if touch on bottom bar area"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public setMeizuSystemUIOptions(I)V
    .locals 0
    .param p1, "meizuSystemuiOptions"    # I
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "yuchao@SHELL.Feature modify for changing changing statusbar icon color theme"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
...
.method public shouldCloseOnTouchNoSlop(Landroid/content/Context;Landroid/view/MotionEvent;)Z
    ...
    .annotation build Landroid/annotation/FlymeHook;
        level = .enum Landroid/annotation/FlymeHook$FlymeHookType;->NEW_METHOD:Landroid/annotation/FlymeHook$FlymeHookType;
        note = "suyouxiong@SDK.Feature.add report if should close when touch on the outside of DocorView ignoring slop"
        property = .enum Landroid/annotation/FlymeHook$FlymeRomType;->ROM:Landroid/annotation/FlymeHook$FlymeRomType;
    .end annotation
