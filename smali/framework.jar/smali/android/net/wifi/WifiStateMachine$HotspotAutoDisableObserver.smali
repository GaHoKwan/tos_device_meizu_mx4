...
.method public onChange(Z)V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$33302(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$33900(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$32400(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$34000(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/IState;
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$31800(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mDuration:I
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$33300(Landroid/net/wifi/WifiStateMachine;)I
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mDuration:I
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$33300(Landroid/net/wifi/WifiStateMachine;)I
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mIntentStopHotspot:Landroid/app/PendingIntent;
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$33400(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
