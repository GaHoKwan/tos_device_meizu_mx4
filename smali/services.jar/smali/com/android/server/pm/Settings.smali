...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;IIILandroid/os/UserHandle;ZZ)Lcom/android/server/pm/PackageSetting;
    ...
    .line 465
    .local v16, "s":Lcom/android/server/pm/PackageSignatures;
    move-object/from16 v0, p2
    ...
    .line 547
    .end local v16    # "s":Lcom/android/server/pm/PackageSignatures;
    :goto_4
    ...
    invoke-virtual/range {v3 .. v13}, Lcom/android/server/pm/PackageSetting;->setUserState(IIZZZZLjava/lang/String;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    .line 517
    .local v14, "dis":Lcom/android/server/pm/PackageSetting;
    if-eqz v14, :cond_e

    .line 522
    iget-object v4, v14, Lcom/android/server/pm/PackageSetting;->signatures:Lcom/android/server/pm/PackageSignatures;
    ...
    .line 525
    :cond_c
    iget v4, v14, Lcom/android/server/pm/PackageSetting;->appId:I
    ...
    iget-object v5, v14, Lcom/android/server/pm/PackageSetting;->grantedPermissions:Ljava/util/HashSet;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/pm/PackageSetting;->getDisabledComponents(I)Ljava/util/HashSet;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/pm/PackageSetting;->getEnabledComponents(I)Ljava/util/HashSet;
    ...
    .line 552
    .end local v14    # "dis":Lcom/android/server/pm/PackageSetting;
    :cond_f
    if-eqz p12, :cond_10
...
.method getComponentGuestSettingLPr(Landroid/content/ComponentName;I)Z
    ...
    .line 3399
    .local v0, "classNameStr":Ljava/lang/String;
    invoke-virtual {v2, v0, p2}, Lcom/android/server/pm/PackageSetting;->getCurrentGuestStateLPr(Ljava/lang/String;I)Z
...
.method getGuestSettingsLPrList(I)Ljava/util/List;
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/pm/PackageSetting;->readUserState(I)Landroid/content/pm/PackageUserState;
...
.method isGuestHideLPr(Ljava/lang/String;Landroid/content/pm/ComponentInfo;I)Z
    ...
    sget-boolean v6, Lcom/android/server/pm/PackageManagerService;->DEBUG_SETTINGS:Z
    ...
    const-string v8, "isGuestHide - packageName = "
    ...
    iget-object v8, p2, Landroid/content/pm/ComponentInfo;->name:Ljava/lang/String;
    ...
    invoke-virtual {v1, p3}, Lcom/android/server/pm/PackageSetting;->getGusetHideComponents(I)Ljava/util/HashSet;

    move-result-object v8

    invoke-direct {p0, v8}, Lcom/android/server/pm/Settings;->compToString(Ljava/util/HashSet;)Ljava/lang/String;
    ...
    iget-object v7, p2, Landroid/content/pm/ComponentInfo;->name:Ljava/lang/String;
...
.method readPackageRestrictionsLPr(I)V
    ...
    .line 970
    .local v22, "notLaunchedStr":Ljava/lang/String;
    if-nez v26, :cond_f
    ...
    .line 980
    .local v14, "guestComponens":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    invoke-interface/range {v25 .. v25}, Lorg/xmlpull/v1/XmlPullParser;->getDepth()I

    move-result v24

    .line 982
    .local v24, "packageDepth":I
    :cond_9
    :goto_d
    invoke-interface/range {v25 .. v25}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    ...
    .end local v14    # "guestComponens":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v16    # "blockedStr":Ljava/lang/String;
    .end local v20    # "installedStr":Ljava/lang/String;
    .end local v22    # "notLaunchedStr":Ljava/lang/String;
    .end local v24    # "packageDepth":I
    ...
    .restart local v22    # "notLaunchedStr":Ljava/lang/String;
    :cond_f
    ...
    .restart local v14    # "guestComponens":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v24    # "packageDepth":I
    :cond_10
    ...
    .line 1002
    invoke-virtual/range {v4 .. v14}, Lcom/android/server/pm/PackageSetting;->setUserState(IIZZZZLjava/lang/String;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
