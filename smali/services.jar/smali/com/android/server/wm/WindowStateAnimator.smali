...
.method applyAnimationLocked(IZ)Z
    ...
    invoke-virtual {v5}, Landroid/view/WindowManager$LayoutParams;->isWindowAnimationEnterEnable()Z
    ...
    iget-object v6, v6, Landroid/view/WindowManager$LayoutParams;->windowAnimationEnter:Landroid/view/WindowAnimationInfo;

    invoke-virtual {v5, v6}, Lcom/android/server/wm/AppTransition;->loadWindowAnimation(Landroid/view/WindowAnimationInfo;)Landroid/view/animation/Animation;
    ...
    invoke-virtual {v5}, Landroid/view/WindowManager$LayoutParams;->isWindowAnimationExitEnable()Z
    ...
    iget-object v6, v6, Landroid/view/WindowManager$LayoutParams;->windowAnimationExit:Landroid/view/WindowAnimationInfo;
...
.method applyDecorRect(Landroid/graphics/Rect;)V
    ...
    iget v5, v4, Lcom/android/server/wm/WindowState;->mXOffset:I
    ...
    .line 1196
    .local v0, "offX":I
    iget v5, v4, Lcom/android/server/wm/WindowState;->mYOffset:I
    ...
    :cond_0
    :goto_1
    iget-boolean v5, v4, Lcom/android/server/wm/WindowState;->mEnforceSizeCompat:Z

    if-eqz v5, :cond_1

    iget v5, v4, Lcom/android/server/wm/WindowState;->mInvGlobalScale:F
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/WindowManagerService;->getStatusbarHeight()I
    ...
    .line 1215
    :cond_3
    sget-boolean v5, Lcom/android/server/wm/WindowManagerService;->OLD_MOVE_WIN_MODE:Z

    if-nez v5, :cond_4

    iget v5, v4, Lcom/android/server/wm/WindowState;->mBackupFlags:I
...
.method computeShownFrameLocked()V
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/wm/WindowState;->isInMovedMode()Z
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/wm/WindowState;->moveShownFrame()V
...
.method destroySurfaceLocked()V
    ...
    iget-object v3, p0, Lcom/android/server/wm/WindowStateAnimator;->mActionBarAnimator:Lcom/android/server/wm/ActionbarAnimator;
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/ActionbarAnimator;->destroy()V

    .line 928
    iput-object v7, p0, Lcom/android/server/wm/WindowStateAnimator;->mActionBarAnimator:Lcom/android/server/wm/ActionbarAnimator;
...
.method stepAnimationLocked(J)Z
    ...
    iput-boolean v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mHasTransformation:Z

    .line 278
    const/4 v5, 0x1

    iput-boolean v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mHasLocalTransformation:Z
    ...
    iget v7, v7, Lcom/android/server/wm/WindowManagerService;->mWindowAnimationScale:F
    ...
    iget-object v5, v5, Lcom/android/server/wm/AppWindowAnimator;->mActionbarAnimator:Lcom/android/server/wm/ActionbarAnimator;
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/AppWindowToken;->findNonStartingMainWindow()Lcom/android/server/wm/WindowState;
    ...
    iget v5, v5, Landroid/view/WindowManager$LayoutParams;->meizuFlags:I
    ...
    iget-object v5, v5, Lcom/android/server/wm/WindowManagerService;->mExitingActionbarAnimators:Ljava/util/ArrayList;
    ...
    check-cast v0, Lcom/android/server/wm/ActionbarAnimator;
    ...
    .end local v3    # "i":I
    .end local v4    # "mainWin":Lcom/android/server/wm/WindowState;
    :cond_2
    iget-object v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;
    ...
    .line 388
    :cond_c
    const-wide/16 v5, 0x1020

    const-string v7, "win animation done"
    ...
    iget-boolean v7, v7, Lcom/android/server/wm/WindowState;->mExiting:Z
    ...
    iput-object v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mAnimation:Landroid/view/animation/Animation;
    ...
    iput-object v6, v5, Lcom/android/server/wm/WindowAnimator;->mWindowDetachedWallpaper:Lcom/android/server/wm/WindowState;
    ...
    const-string v6, "setAnimationLocked: setting mFocusMayChange true"
    ...
    const-string v7, ": first real window done animating"
    ...
    invoke-virtual {v5, v1, v6}, Lcom/android/server/wm/WindowAnimator;->setPendingLayoutChanges(II)V
    ...
    invoke-virtual {v7, v1}, Lcom/android/server/wm/WindowAnimator;->getPendingLayoutChanges(I)I
    ...
    .line 460
    :cond_19
    iget-object v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mActionBarAnimator:Lcom/android/server/wm/ActionbarAnimator;
    ...
    iget-object v6, p0, Lcom/android/server/wm/WindowStateAnimator;->mActionBarAnimator:Lcom/android/server/wm/ActionbarAnimator;
    ...
    iput-object v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mActionBarAnimator:Lcom/android/server/wm/ActionbarAnimator;
...
.method updateSurfaceWindowCrop(Z)V
    ...
    .line 1245
    .local v0, "displayInfo":Landroid/view/DisplayInfo;
    invoke-virtual {p0, v3}, Lcom/android/server/wm/WindowStateAnimator;->updateSurfaceWindowCropForMeizu(Lcom/android/server/wm/WindowState;)V
    ...
    iget-object v4, v3, Lcom/android/server/wm/WindowState;->mDecorFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/WindowManagerService;->getStatusbarHeight()I
