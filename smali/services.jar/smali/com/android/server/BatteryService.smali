...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 949
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mSendBatteryLowWarningDialog:Z

    .line 950
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mSystemReady:Z

    .line 951
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBatteryLow20:Z

    .line 952
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBatteryLow10:Z

    .line 953
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBatteryLow5:Z
    ...
    .line 182
    .local v1, "bfilter":Landroid/content/IntentFilter;
    ...
    invoke-direct {v2, p0, v4}, Lcom/android/server/BatteryService$BatteryListener;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V
...
.method static synthetic access$1900(Lcom/android/server/BatteryService;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method private processValuesLocked()V
    ...
    .line 580
    :cond_a
    new-instance v9, Lcom/android/server/BatteryService$Injector;

    invoke-direct {v9, p0}, Lcom/android/server/BatteryService$Injector;-><init>(Lcom/android/server/BatteryService;)V

    .line 581
    .local v9, "instance":Lcom/android/server/BatteryService$Injector;
    invoke-virtual {v9, v10, v13}, Lcom/android/server/BatteryService$Injector;->onBatteryLow(IZ)V
    ...
    .line 605
    .end local v9    # "instance":Lcom/android/server/BatteryService$Injector;
...
.method private shutdownIfNoPowerLocked()V
    ...
    const-string v4, "shutdownIfNoPower the battery Level = "
    ...
    const-string v3, "mBatteryLevel == 0 mBatteryVoltage == "
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/BatteryService$Injector;->writeMessageToFile(Ljava/lang/String;)V
...
.method private shutdownIfOverTempLocked()V
    ...
    iget v4, p0, Lcom/android/server/BatteryService;->mShutdownBatteryTemperature:I

    if-le v3, v4, :cond_1

    :cond_0
    iget-boolean v3, p0, Lcom/android/server/BatteryService;->mEnableScreen:Z
    ...
    const-string v4, "mBatteryTemperature== "
    ...
    const-string v4, " mBatteryVoltage == "
