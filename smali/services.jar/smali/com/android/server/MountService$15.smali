...
.method constructor <init>(Lcom/android/server/MountService;Z)V
    ...
    iput-boolean p2, p0, Lcom/android/server/MountService$15;->val$doShare:Z
...
.method public run()V
    ...
    .line 4861
    :cond_0
    iget-object v1, p0, Lcom/android/server/MountService$15;->this$0:Lcom/android/server/MountService;

    # invokes: Lcom/android/server/MountService;->waitForReady()V
    invoke-static {v1}, Lcom/android/server/MountService;->access$3400(Lcom/android/server/MountService;)V

    .line 4862
    iget-object v1, p0, Lcom/android/server/MountService$15;->this$0:Lcom/android/server/MountService;

    # invokes: Lcom/android/server/MountService;->doGetCDRomState()I
    invoke-static {v1}, Lcom/android/server/MountService;->access$5600(Lcom/android/server/MountService;)I
    ...
    iget-boolean v1, p0, Lcom/android/server/MountService$15;->val$doShare:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/MountService$15;->val$doShare:Z

    # invokes: Lcom/android/server/MountService;->doShareUnshareCDRom(Z)V
    invoke-static {v1, v2}, Lcom/android/server/MountService;->access$5700(Lcom/android/server/MountService;Z)V
